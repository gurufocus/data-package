...
/**
 * FundamentalsIREITNODIRECTCashflowStatement Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FundamentalsIREITNODIRECTCashflowStatement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'fundamentals_I_REIT_NO_DIRECT_cashflow_statement';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('ffo', $data ?? [], null);
    ...
    */
     ...
     * @return float|null
     */
    public function getFfo()
    {
        return $this->container['ffo'];
    }

    /**
     * Sets ffo
     *
     * @param float|null $ffo <p>{{FFO}} (Funds from operations) refers to the figure used by real estate investment trusts (REITs) to define the cash flow from their operations. It is calculated by adding depreciation and amortization to earnings, subtracting any gains on sales.</p>
     *
     * @return self
     */
    public function setFfo($ffo)
    {
        if (is_null($ffo)) {
            throw new \InvalidArgumentException('non-nullable ffo cannot be null');
        }
        $this->container['ffo'] = $ffo;
