...
/**
 * ValuationsIREITNODIRECTPerShareData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ValuationsIREITNODIRECTPerShareData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'valuations_I_REIT_NO_DIRECT_per_share_data';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('ffo_per_share', $data ?? [], null);
    ...
    */
     ...
     * @return float|null
     */
    public function getFfoPerShare()
    {
        return $this->container['ffo_per_share'];
    }

    /**
     * Sets ffo_per_share
     *
     * @param float|null $ffo_per_share <p>{{FFO}} (Funds from operations) refers to the figure used by real estate investment trusts (REITs) to define the cash flow from their operations. It is calculated by adding depreciation and amortization to earnings, subtracting any gains on sales.</p>
     *
     * @return self
     */
    public function setFfoPerShare($ffo_per_share)
    {
        if (is_null($ffo_per_share)) {
            throw new \InvalidArgumentException('non-nullable ffo_per_share cannot be null');
        }
        $this->container['ffo_per_share'] = $ffo_per_share;
