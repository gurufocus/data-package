...
class FundamentalsNNOREITDIRECT(BaseModel):
    """
    FundamentalsNNOREITDIRECT
    """ # noqa: E501
    balance_sheet: Optional[FundamentalsNNOREITDIRECTBalanceSheet] = None
    basic_information: Optional[FundamentalsNNOREITDIRECTBasicInformation] = None
    cashflow_statement: Optional[FundamentalsNNOREITDIRECTCashflowStatement] = None
    income_statement: Optional[FundamentalsNNOREITDIRECTIncomeStatement] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "balance_sheet": FundamentalsNNOREITDIRECTBalanceSheet.from_dict(obj["balance_sheet"]) if obj.get("balance_sheet") is not None else None,
            "basic_information": FundamentalsNNOREITDIRECTBasicInformation.from_dict(obj["basic_information"]) if obj.get("basic_information") is not None else None,
            "cashflow_statement": FundamentalsNNOREITDIRECTCashflowStatement.from_dict(obj["cashflow_statement"]) if obj.get("cashflow_statement") is not None else None,
            "income_statement": FundamentalsNNOREITDIRECTIncomeStatement.from_dict(obj["income_statement"]) if obj.get("income_statement") is not None else None
        })
        return _obj
