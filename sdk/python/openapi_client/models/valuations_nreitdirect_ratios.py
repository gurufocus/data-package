...
class ValuationsNREITDIRECTRatios(BaseModel):
    """
    ValuationsNREITDIRECTRatios
    """ # noqa: E501
    capex_to_operating_cash_flow: Optional[Union[StrictFloat, StrictInt]] = None
    capex_to_operating_income: Optional[Union[StrictFloat, StrictInt]] = None
    capex_to_revenue: Optional[Union[StrictFloat, StrictInt]] = None
    cash_conversion_cycle: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Cash Conversion Cycle is one of several measures of management effectiveness. It equals Days Sales Outstanding + Days Inventory - Days Payable.")
    cost_of_goods_sold_to_revenue: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The ratio of cost of goods sold to sales")
    days_inventory: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The Days Inventory is an efficiency ratio that measures the average number of days the company holds its inventory before selling it. The ratio measures the number of days funds are tied up in inventory. Inventory levels (measured at cost) are divided by sales per day (also measured at cost rather than selling price.)")
    days_payable: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Days payable outstanding (DPO) is an efficiency ratio that measures the average number of days a company takes to pay its suppliers.")
    days_sales_outstanding: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Days sales outstanding (DSO) is a measure of the average number of days that it takes a company to collect payment after a sale has been made.")
    ...
    gross_profit_to_asset: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The ratio of a company's gross profit to total assets")
    inventory_to_revenue: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The ratio of total inventory to total revenues")
    ...
    rd2rev: Optional[Union[StrictFloat, StrictInt]] = None
    ...
    __properties: ClassVar[List[str]] = ["capex_to_operating_cash_flow", "capex_to_operating_income", "capex_to_revenue", "cash_conversion_cycle", "cost_of_goods_sold_to_revenue", "days_inventory", "days_payable", "days_sales_outstanding", "debt_to_asset", "debt_to_equity", "degree_of_financial_leverage", "degree_of_operating_leverage", "dividend_to_ffo", "ebitda_margin", "effective_interest_rate", "equity_to_asset", "fcf_margin", "gross_margin", "gross_profit_to_asset", "inventory_to_revenue", "inventory_turnover", "liabilities_to_assets", "net_margin", "operating_margin", "payout", "rd2rev", "receivables_turnover", "return_on_tangible_asset", "return_on_tangible_equity", "roa", "roc_joel", "roce", "roe", "roe_adj", "roic", "roiic_1y", "rore_5y", "turnover", "wacc"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "capex_to_operating_income": obj.get("capex_to_operating_income"),
            "capex_to_revenue": obj.get("capex_to_revenue"),
            "cash_conversion_cycle": obj.get("cash_conversion_cycle"),
            "cost_of_goods_sold_to_revenue": obj.get("cost_of_goods_sold_to_revenue"),
            "days_inventory": obj.get("days_inventory"),
            "days_payable": obj.get("days_payable"),
            ...
            "gross_profit_to_asset": obj.get("gross_profit_to_asset"),
            "inventory_to_revenue": obj.get("inventory_to_revenue"),
