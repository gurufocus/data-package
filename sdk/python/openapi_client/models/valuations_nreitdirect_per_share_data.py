...
class ValuationsNREITDIRECTPerShareData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["book_value_per_share", "cash_flow_from_operations_per_share", "cash_per_share", "dividends_per_share", "earning_per_share_diluted", "ebit_per_share", "ebitda_per_share", "eps_without_nri", "ffo_per_share", "free_cash_flow_per_share", "month_end_stock_price", "owner_earnings", "revenue_per_share", "tangibles_book_per_share", "total_debt_per_share"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ffo_per_share": obj.get("ffo_per_share"),
