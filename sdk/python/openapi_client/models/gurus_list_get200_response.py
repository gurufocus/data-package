...
class GurusListGet200Response(BaseModel):
    """
    GurusListGet200Response
    """ # noqa: E501
    data: Optional[List[GurusListGet200ResponseDataInner]] = None
    page: Optional[StrictInt] = None
    per_page: Optional[StrictInt] = None
    total: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["data", "page", "per_page", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [GurusListGet200ResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "page": obj.get("page"),
