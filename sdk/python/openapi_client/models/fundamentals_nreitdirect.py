...
class FundamentalsNREITDIRECT(BaseModel):
    """
    FundamentalsNREITDIRECT
    """ # noqa: E501
    balance_sheet: Optional[FundamentalsNREITDIRECTBalanceSheet] = None
    basic_information: Optional[FundamentalsNREITDIRECTBasicInformation] = None
    cashflow_statement: Optional[FundamentalsNREITDIRECTCashflowStatement] = None
    income_statement: Optional[FundamentalsNREITDIRECTIncomeStatement] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "balance_sheet": FundamentalsNREITDIRECTBalanceSheet.from_dict(obj["balance_sheet"]) if obj.get("balance_sheet") is not None else None,
            "basic_information": FundamentalsNREITDIRECTBasicInformation.from_dict(obj["basic_information"]) if obj.get("basic_information") is not None else None,
            "cashflow_statement": FundamentalsNREITDIRECTCashflowStatement.from_dict(obj["cashflow_statement"]) if obj.get("cashflow_statement") is not None else None,
            "income_statement": FundamentalsNREITDIRECTIncomeStatement.from_dict(obj["income_statement"]) if obj.get("income_statement") is not None else None
        })
        return _obj
