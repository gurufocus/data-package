...
class FundamentalsIREITNODIRECT(BaseModel):
    """
    FundamentalsIREITNODIRECT
    """ # noqa: E501
    balance_sheet: Optional[FundamentalsIREITNODIRECTBalanceSheet] = None
    basic_information: Optional[FundamentalsIREITNODIRECTBasicInformation] = None
    cashflow_statement: Optional[FundamentalsIREITNODIRECTCashflowStatement] = None
    income_statement: Optional[FundamentalsIREITNODIRECTIncomeStatement] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "balance_sheet": FundamentalsIREITNODIRECTBalanceSheet.from_dict(obj["balance_sheet"]) if obj.get("balance_sheet") is not None else None,
            "basic_information": FundamentalsIREITNODIRECTBasicInformation.from_dict(obj["basic_information"]) if obj.get("basic_information") is not None else None,
            "cashflow_statement": FundamentalsIREITNODIRECTCashflowStatement.from_dict(obj["cashflow_statement"]) if obj.get("cashflow_statement") is not None else None,
            "income_statement": FundamentalsIREITNODIRECTIncomeStatement.from_dict(obj["income_statement"]) if obj.get("income_statement") is not None else None
        })
        return _obj
