...
class ValuationsNNOREITDIRECT(BaseModel):
    """
    ValuationsNNOREITDIRECT
    """ # noqa: E501
    basic_information: Optional[ValuationsNNOREITDIRECTBasicInformation] = None
    per_share_data: Optional[ValuationsNNOREITDIRECTPerShareData] = None
    ratios: Optional[ValuationsNNOREITDIRECTRatios] = None
    valuation_ratios: Optional[ValuationsNNOREITDIRECTValuationRatios] = None
    valuationand_quality: Optional[ValuationsNNOREITDIRECTValuationandQuality] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "basic_information": ValuationsNNOREITDIRECTBasicInformation.from_dict(obj["basic_information"]) if obj.get("basic_information") is not None else None,
            "per_share_data": ValuationsNNOREITDIRECTPerShareData.from_dict(obj["per_share_data"]) if obj.get("per_share_data") is not None else None,
            "ratios": ValuationsNNOREITDIRECTRatios.from_dict(obj["ratios"]) if obj.get("ratios") is not None else None,
            "valuation_ratios": ValuationsNNOREITDIRECTValuationRatios.from_dict(obj["valuation_ratios"]) if obj.get("valuation_ratios") is not None else None,
            "valuationand_quality": ValuationsNNOREITDIRECTValuationandQuality.from_dict(obj["valuationand_quality"]) if obj.get("valuationand_quality") is not None else None
        })
        return _obj
