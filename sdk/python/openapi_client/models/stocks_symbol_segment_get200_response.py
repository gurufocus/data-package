...
class StocksSymbolSegmentGet200Response(BaseModel):
    """
    StocksSymbolSegmentGet200Response
    """ # noqa: E501
    annually: Optional[List[Any]] = None
    basic_information: Optional[StockSegmentBasicInformation] = None
    quarterly: Optional[List[Any]] = None
    ttm: Optional[Dict[str, Any]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "annually": obj.get("annually"),
            "basic_information": StockSegmentBasicInformation.from_dict(obj["basic_information"]) if obj.get("basic_information") is not None else None,
