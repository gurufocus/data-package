...
class ValuationsNNOREITNODIRECT(BaseModel):
    """
    ValuationsNNOREITNODIRECT
    """ # noqa: E501
    basic_information: Optional[ValuationsNNOREITNODIRECTBasicInformation] = None
    per_share_data: Optional[ValuationsNNOREITNODIRECTPerShareData] = None
    ratios: Optional[ValuationsNNOREITNODIRECTRatios] = None
    valuation_ratios: Optional[ValuationsNNOREITNODIRECTValuationRatios] = None
    valuationand_quality: Optional[ValuationsNNOREITNODIRECTValuationandQuality] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "basic_information": ValuationsNNOREITNODIRECTBasicInformation.from_dict(obj["basic_information"]) if obj.get("basic_information") is not None else None,
            "per_share_data": ValuationsNNOREITNODIRECTPerShareData.from_dict(obj["per_share_data"]) if obj.get("per_share_data") is not None else None,
            "ratios": ValuationsNNOREITNODIRECTRatios.from_dict(obj["ratios"]) if obj.get("ratios") is not None else None,
            "valuation_ratios": ValuationsNNOREITNODIRECTValuationRatios.from_dict(obj["valuation_ratios"]) if obj.get("valuation_ratios") is not None else None,
            "valuationand_quality": ValuationsNNOREITNODIRECTValuationandQuality.from_dict(obj["valuationand_quality"]) if obj.get("valuationand_quality") is not None else None
        })
        return _obj
