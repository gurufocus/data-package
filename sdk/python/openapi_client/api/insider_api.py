...
class INSIDERApi:
    ...
    @validate_call
    def insiders_date_get(
        self,
        var_date: Annotated[date, Field(description="Date in YYYY-MM-DD format")],
        ...
        _param = self._insiders_date_get_serialize(
            var_date=var_date,
    ...
    @validate_call
    def insiders_date_get_with_http_info(
        self,
        var_date: Annotated[date, Field(description="Date in YYYY-MM-DD format")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[InsiderTransaction]]:
        """A comprehensive record of insider trading and institutional ownership for investment research or powering data-driven financial tools that track executive trading behavior over time
    ...
    @validate_call
    def insiders_date_get_without_preload_content(
        self,
        var_date: Annotated[date, Field(description="Date in YYYY-MM-DD format")],
        _request_timeout: Union[
            None,
    ...
    def _insiders_date_get_serialize(
        self,
        var_date,
        _request_auth,
        _content_type,
