...
class TestValuationsNREITDIRECT(unittest.TestCase):
    """ValuationsNREITDIRECT unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValuationsNREITDIRECT:
        """Test ValuationsNREITDIRECT
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValuationsNREITDIRECT`
        """
        model = ValuationsNREITDIRECT()
        if include_optional:
            return ValuationsNREITDIRECT(
                basic_information = openapi_client.models.valuations_n_reit_direct_basic_information.valuations_N_REIT_DIRECT_basic_information(
                    company = '', 
                    company_id = '', 
                    exchange = '', 
                    stockid = '', 
                    symbol = '', ),
                per_share_data = openapi_client.models.valuations_n_reit_direct_per_share_data.valuations_N_REIT_DIRECT_per_share_data(
                ...
                ratios = openapi_client.models.valuations_n_reit_direct_ratios.valuations_N_REIT_DIRECT_ratios(
                    ...
                    turnover = 1.337, 
                    wacc = 1.337, ),
                valuation_ratios = openapi_client.models.valuations_n_reit_direct_valuation_ratios.valuations_N_REIT_DIRECT_valuation_ratios(
                    ...
                    yield = 1.337, ),
                valuationand_quality = openapi_client.models.valuations_n_reit_direct_valuationand_quality.valuations_N_REIT_DIRECT_valuationand_quality(
                    beta = 1.337, 
                    bs_share = 1.337, 
                    buyback_yield = 1.337, 
                    cash_ratio = 1.337, 
    ...
    def testValuationsNREITDIRECT(self):
        """Test ValuationsNREITDIRECT"""
