...
class TestValuationsNREITNODIRECTRatios(unittest.TestCase):
    """ValuationsNREITNODIRECTRatios unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValuationsNREITNODIRECTRatios:
        """Test ValuationsNREITNODIRECTRatios
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValuationsNREITNODIRECTRatios`
        """
        model = ValuationsNREITNODIRECTRatios()
        if include_optional:
            return ValuationsNREITNODIRECTRatios(
    ...
    def testValuationsNREITNODIRECTRatios(self):
        """Test ValuationsNREITNODIRECTRatios"""
