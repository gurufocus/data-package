...
class TestValuationsNNOREITNODIRECTValuationandQuality(unittest.TestCase):
    """ValuationsNNOREITNODIRECTValuationandQuality unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValuationsNNOREITNODIRECTValuationandQuality:
        """Test ValuationsNNOREITNODIRECTValuationandQuality
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValuationsNNOREITNODIRECTValuationandQuality`
        """
        model = ValuationsNNOREITNODIRECTValuationandQuality()
        if include_optional:
            return ValuationsNNOREITNODIRECTValuationandQuality(
                beta = 1.337,
                bs_share = 1.337,
                buyback_yield = 1.337,
                cash_ratio = 1.337,
    ...
    def testValuationsNNOREITNODIRECTValuationandQuality(self):
        """Test ValuationsNNOREITNODIRECTValuationandQuality"""
