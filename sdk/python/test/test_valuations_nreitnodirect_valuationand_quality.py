...
class TestValuationsNREITNODIRECTValuationandQuality(unittest.TestCase):
    """ValuationsNREITNODIRECTValuationandQuality unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValuationsNREITNODIRECTValuationandQuality:
        """Test ValuationsNREITNODIRECTValuationandQuality
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValuationsNREITNODIRECTValuationandQuality`
        """
        model = ValuationsNREITNODIRECTValuationandQuality()
        if include_optional:
            return ValuationsNREITNODIRECTValuationandQuality(
                beta = 1.337,
                bs_share = 1.337,
                buyback_yield = 1.337,
                cash_ratio = 1.337,
    ...
    def testValuationsNREITNODIRECTValuationandQuality(self):
        """Test ValuationsNREITNODIRECTValuationandQuality"""
