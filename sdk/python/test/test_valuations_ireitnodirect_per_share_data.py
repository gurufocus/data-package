...
class TestValuationsIREITNODIRECTPerShareData(unittest.TestCase):
    """ValuationsIREITNODIRECTPerShareData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValuationsIREITNODIRECTPerShareData:
        """Test ValuationsIREITNODIRECTPerShareData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValuationsIREITNODIRECTPerShareData`
        """
        model = ValuationsIREITNODIRECTPerShareData()
        if include_optional:
            return ValuationsIREITNODIRECTPerShareData(
    ...
    def testValuationsIREITNODIRECTPerShareData(self):
        """Test ValuationsIREITNODIRECTPerShareData"""
