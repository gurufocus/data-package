...
class TestStockFundamentalsAnnuallyInner(unittest.TestCase):
    """StockFundamentalsAnnuallyInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StockFundamentalsAnnuallyInner:
        """Test StockFundamentalsAnnuallyInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StockFundamentalsAnnuallyInner`
        """
        model = StockFundamentalsAnnuallyInner()
        if include_optional:
    ...
    def testStockFundamentalsAnnuallyInner(self):
        """Test StockFundamentalsAnnuallyInner"""
