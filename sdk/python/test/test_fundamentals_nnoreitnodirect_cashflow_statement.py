...
class TestFundamentalsNNOREITNODIRECTCashflowStatement(unittest.TestCase):
    """FundamentalsNNOREITNODIRECTCashflowStatement unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FundamentalsNNOREITNODIRECTCashflowStatement:
        """Test FundamentalsNNOREITNODIRECTCashflowStatement
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FundamentalsNNOREITNODIRECTCashflowStatement`
        """
        model = FundamentalsNNOREITNODIRECTCashflowStatement()
        if include_optional:
            return FundamentalsNNOREITNODIRECTCashflowStatement(
    ...
    def testFundamentalsNNOREITNODIRECTCashflowStatement(self):
        """Test FundamentalsNNOREITNODIRECTCashflowStatement"""
