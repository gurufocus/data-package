...
class TestValuationsINOREITNODIRECTValuationRatios(unittest.TestCase):
    """ValuationsINOREITNODIRECTValuationRatios unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValuationsINOREITNODIRECTValuationRatios:
        """Test ValuationsINOREITNODIRECTValuationRatios
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValuationsINOREITNODIRECTValuationRatios`
        """
        model = ValuationsINOREITNODIRECTValuationRatios()
        if include_optional:
            return ValuationsINOREITNODIRECTValuationRatios(
    ...
    def testValuationsINOREITNODIRECTValuationRatios(self):
        """Test ValuationsINOREITNODIRECTValuationRatios"""
