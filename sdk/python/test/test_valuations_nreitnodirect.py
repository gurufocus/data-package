...
class TestValuationsNREITNODIRECT(unittest.TestCase):
    """ValuationsNREITNODIRECT unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValuationsNREITNODIRECT:
        """Test ValuationsNREITNODIRECT
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValuationsNREITNODIRECT`
        """
        model = ValuationsNREITNODIRECT()
        if include_optional:
            return ValuationsNREITNODIRECT(
                basic_information = openapi_client.models.valuations_n_reit_no_direct_basic_information.valuations_N_REIT_NO_DIRECT_basic_information(
                    company = '', 
                    company_id = '', 
                    exchange = '', 
                    stockid = '', 
                    symbol = '', ),
                per_share_data = openapi_client.models.valuations_n_reit_no_direct_per_share_data.valuations_N_REIT_NO_DIRECT_per_share_data(
                ...
                ratios = openapi_client.models.valuations_n_reit_no_direct_ratios.valuations_N_REIT_NO_DIRECT_ratios(
                    ...
                    turnover = 1.337, 
                    wacc = 1.337, ),
                valuation_ratios = openapi_client.models.valuations_n_reit_no_direct_valuation_ratios.valuations_N_REIT_NO_DIRECT_valuation_ratios(
                    ...
                    yield = 1.337, ),
                valuationand_quality = openapi_client.models.valuations_n_reit_no_direct_valuationand_quality.valuations_N_REIT_NO_DIRECT_valuationand_quality(
                    beta = 1.337, 
                    bs_share = 1.337, 
                    buyback_yield = 1.337, 
                    cash_ratio = 1.337, 
    ...
    def testValuationsNREITNODIRECT(self):
        """Test ValuationsNREITNODIRECT"""
