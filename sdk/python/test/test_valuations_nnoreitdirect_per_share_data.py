...
class TestValuationsNNOREITDIRECTPerShareData(unittest.TestCase):
    """ValuationsNNOREITDIRECTPerShareData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValuationsNNOREITDIRECTPerShareData:
        """Test ValuationsNNOREITDIRECTPerShareData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValuationsNNOREITDIRECTPerShareData`
        """
        model = ValuationsNNOREITDIRECTPerShareData()
        if include_optional:
            return ValuationsNNOREITDIRECTPerShareData(
    ...
    def testValuationsNNOREITDIRECTPerShareData(self):
        """Test ValuationsNNOREITDIRECTPerShareData"""
