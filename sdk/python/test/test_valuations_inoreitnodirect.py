...
class TestValuationsINOREITNODIRECT(unittest.TestCase):
    """ValuationsINOREITNODIRECT unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValuationsINOREITNODIRECT:
        """Test ValuationsINOREITNODIRECT
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValuationsINOREITNODIRECT`
        """
        model = ValuationsINOREITNODIRECT()
        if include_optional:
            return ValuationsINOREITNODIRECT(
                basic_information = openapi_client.models.valuations_i_no_reit_no_direct_basic_information.valuations_I_NO_REIT_NO_DIRECT_basic_information(
                    company = '', 
                    company_id = '', 
                    exchange = '', 
                    stockid = '', 
                    symbol = '', ),
                per_share_data = openapi_client.models.valuations_i_no_reit_no_direct_per_share_data.valuations_I_NO_REIT_NO_DIRECT_per_share_data(
                ...
                ratios = openapi_client.models.valuations_i_no_reit_no_direct_ratios.valuations_I_NO_REIT_NO_DIRECT_ratios(
                    ...
                    turnover = 1.337, 
                    wacc = 1.337, ),
                valuation_ratios = openapi_client.models.valuations_i_no_reit_no_direct_valuation_ratios.valuations_I_NO_REIT_NO_DIRECT_valuation_ratios(
                    ...
                    yield = 1.337, ),
                valuationand_quality = openapi_client.models.valuations_i_no_reit_no_direct_valuationand_quality.valuations_I_NO_REIT_NO_DIRECT_valuationand_quality(
                    beta = 1.337, 
                    bs_share = 1.337, 
                    buyback_yield = 1.337, 
    ...
    def testValuationsINOREITNODIRECT(self):
        """Test ValuationsINOREITNODIRECT"""
