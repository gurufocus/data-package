...
class TestValuationsNNOREITDIRECTValuationRatios(unittest.TestCase):
    """ValuationsNNOREITDIRECTValuationRatios unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValuationsNNOREITDIRECTValuationRatios:
        """Test ValuationsNNOREITDIRECTValuationRatios
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValuationsNNOREITDIRECTValuationRatios`
        """
        model = ValuationsNNOREITDIRECTValuationRatios()
        if include_optional:
            return ValuationsNNOREITDIRECTValuationRatios(
    ...
    def testValuationsNNOREITDIRECTValuationRatios(self):
        """Test ValuationsNNOREITDIRECTValuationRatios"""
