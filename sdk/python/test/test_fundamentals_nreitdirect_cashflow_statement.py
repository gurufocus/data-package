...
class TestFundamentalsNREITDIRECTCashflowStatement(unittest.TestCase):
    """FundamentalsNREITDIRECTCashflowStatement unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FundamentalsNREITDIRECTCashflowStatement:
        """Test FundamentalsNREITDIRECTCashflowStatement
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FundamentalsNREITDIRECTCashflowStatement`
        """
        model = FundamentalsNREITDIRECTCashflowStatement()
        if include_optional:
            return FundamentalsNREITDIRECTCashflowStatement(
    ...
    def testFundamentalsNREITDIRECTCashflowStatement(self):
        """Test FundamentalsNREITDIRECTCashflowStatement"""
