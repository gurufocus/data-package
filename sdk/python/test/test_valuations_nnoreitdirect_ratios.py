...
class TestValuationsNNOREITDIRECTRatios(unittest.TestCase):
    """ValuationsNNOREITDIRECTRatios unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValuationsNNOREITDIRECTRatios:
        """Test ValuationsNNOREITDIRECTRatios
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValuationsNNOREITDIRECTRatios`
        """
        model = ValuationsNNOREITDIRECTRatios()
        if include_optional:
            return ValuationsNNOREITDIRECTRatios(
    ...
    def testValuationsNNOREITDIRECTRatios(self):
        """Test ValuationsNNOREITDIRECTRatios"""
