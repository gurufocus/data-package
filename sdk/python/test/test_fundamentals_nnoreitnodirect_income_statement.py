...
class TestFundamentalsNNOREITNODIRECTIncomeStatement(unittest.TestCase):
    """FundamentalsNNOREITNODIRECTIncomeStatement unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FundamentalsNNOREITNODIRECTIncomeStatement:
        """Test FundamentalsNNOREITNODIRECTIncomeStatement
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FundamentalsNNOREITNODIRECTIncomeStatement`
        """
        model = FundamentalsNNOREITNODIRECTIncomeStatement()
        if include_optional:
            return FundamentalsNNOREITNODIRECTIncomeStatement(
    ...
    def testFundamentalsNNOREITNODIRECTIncomeStatement(self):
        """Test FundamentalsNNOREITNODIRECTIncomeStatement"""
