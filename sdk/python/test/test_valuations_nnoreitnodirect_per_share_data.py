...
class TestValuationsNNOREITNODIRECTPerShareData(unittest.TestCase):
    """ValuationsNNOREITNODIRECTPerShareData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValuationsNNOREITNODIRECTPerShareData:
        """Test ValuationsNNOREITNODIRECTPerShareData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValuationsNNOREITNODIRECTPerShareData`
        """
        model = ValuationsNNOREITNODIRECTPerShareData()
        if include_optional:
            return ValuationsNNOREITNODIRECTPerShareData(
    ...
    def testValuationsNNOREITNODIRECTPerShareData(self):
        """Test ValuationsNNOREITNODIRECTPerShareData"""
