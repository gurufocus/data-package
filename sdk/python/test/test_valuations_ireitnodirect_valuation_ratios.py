...
class TestValuationsIREITNODIRECTValuationRatios(unittest.TestCase):
    """ValuationsIREITNODIRECTValuationRatios unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValuationsIREITNODIRECTValuationRatios:
        """Test ValuationsIREITNODIRECTValuationRatios
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValuationsIREITNODIRECTValuationRatios`
        """
        model = ValuationsIREITNODIRECTValuationRatios()
        if include_optional:
            return ValuationsIREITNODIRECTValuationRatios(
    ...
    def testValuationsIREITNODIRECTValuationRatios(self):
        """Test ValuationsIREITNODIRECTValuationRatios"""
