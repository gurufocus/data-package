...
class TestFundamentalsNNOREITDIRECTBalanceSheet(unittest.TestCase):
    """FundamentalsNNOREITDIRECTBalanceSheet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FundamentalsNNOREITDIRECTBalanceSheet:
        """Test FundamentalsNNOREITDIRECTBalanceSheet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FundamentalsNNOREITDIRECTBalanceSheet`
        """
        model = FundamentalsNNOREITDIRECTBalanceSheet()
        if include_optional:
            return FundamentalsNNOREITDIRECTBalanceSheet(
    ...
    def testFundamentalsNNOREITDIRECTBalanceSheet(self):
        """Test FundamentalsNNOREITDIRECTBalanceSheet"""
