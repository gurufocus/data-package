...
class TestValuationsNREITNODIRECTPerShareData(unittest.TestCase):
    """ValuationsNREITNODIRECTPerShareData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValuationsNREITNODIRECTPerShareData:
        """Test ValuationsNREITNODIRECTPerShareData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValuationsNREITNODIRECTPerShareData`
        """
        model = ValuationsNREITNODIRECTPerShareData()
        if include_optional:
            return ValuationsNREITNODIRECTPerShareData(
    ...
    def testValuationsNREITNODIRECTPerShareData(self):
        """Test ValuationsNREITNODIRECTPerShareData"""
