...
class TestStockFundamentalsTtm(unittest.TestCase):
    """StockFundamentalsTtm unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StockFundamentalsTtm:
        """Test StockFundamentalsTtm
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StockFundamentalsTtm`
        """
        model = StockFundamentalsTtm()
        if include_optional:
    ...
    def testStockFundamentalsTtm(self):
        """Test StockFundamentalsTtm"""
