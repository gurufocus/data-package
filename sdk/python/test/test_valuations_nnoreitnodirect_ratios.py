...
class TestValuationsNNOREITNODIRECTRatios(unittest.TestCase):
    """ValuationsNNOREITNODIRECTRatios unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValuationsNNOREITNODIRECTRatios:
        """Test ValuationsNNOREITNODIRECTRatios
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValuationsNNOREITNODIRECTRatios`
        """
        model = ValuationsNNOREITNODIRECTRatios()
        if include_optional:
            return ValuationsNNOREITNODIRECTRatios(
    ...
    def testValuationsNNOREITNODIRECTRatios(self):
        """Test ValuationsNNOREITNODIRECTRatios"""
