...
class TestValuationsINOREITNODIRECTValuationandQuality(unittest.TestCase):
    """ValuationsINOREITNODIRECTValuationandQuality unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValuationsINOREITNODIRECTValuationandQuality:
        """Test ValuationsINOREITNODIRECTValuationandQuality
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValuationsINOREITNODIRECTValuationandQuality`
        """
        model = ValuationsINOREITNODIRECTValuationandQuality()
        if include_optional:
            return ValuationsINOREITNODIRECTValuationandQuality(
                beta = 1.337,
                bs_share = 1.337,
                buyback_yield = 1.337,
    ...
    def testValuationsINOREITNODIRECTValuationandQuality(self):
        """Test ValuationsINOREITNODIRECTValuationandQuality"""
