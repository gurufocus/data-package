...
class TestFundamentalsNREITNODIRECTCashflowStatement(unittest.TestCase):
    """FundamentalsNREITNODIRECTCashflowStatement unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FundamentalsNREITNODIRECTCashflowStatement:
        """Test FundamentalsNREITNODIRECTCashflowStatement
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FundamentalsNREITNODIRECTCashflowStatement`
        """
        model = FundamentalsNREITNODIRECTCashflowStatement()
        if include_optional:
            return FundamentalsNREITNODIRECTCashflowStatement(
    ...
    def testFundamentalsNREITNODIRECTCashflowStatement(self):
        """Test FundamentalsNREITNODIRECTCashflowStatement"""
