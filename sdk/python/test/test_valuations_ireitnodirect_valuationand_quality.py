...
class TestValuationsIREITNODIRECTValuationandQuality(unittest.TestCase):
    """ValuationsIREITNODIRECTValuationandQuality unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValuationsIREITNODIRECTValuationandQuality:
        """Test ValuationsIREITNODIRECTValuationandQuality
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValuationsIREITNODIRECTValuationandQuality`
        """
        model = ValuationsIREITNODIRECTValuationandQuality()
        if include_optional:
            return ValuationsIREITNODIRECTValuationandQuality(
                beta = 1.337,
                bs_share = 1.337,
                buyback_yield = 1.337,
    ...
    def testValuationsIREITNODIRECTValuationandQuality(self):
        """Test ValuationsIREITNODIRECTValuationandQuality"""
