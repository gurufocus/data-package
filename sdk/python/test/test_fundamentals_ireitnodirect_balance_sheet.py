...
class TestFundamentalsIREITNODIRECTBalanceSheet(unittest.TestCase):
    """FundamentalsIREITNODIRECTBalanceSheet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FundamentalsIREITNODIRECTBalanceSheet:
        """Test FundamentalsIREITNODIRECTBalanceSheet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FundamentalsIREITNODIRECTBalanceSheet`
        """
        model = FundamentalsIREITNODIRECTBalanceSheet()
        if include_optional:
            return FundamentalsIREITNODIRECTBalanceSheet(
    ...
    def testFundamentalsIREITNODIRECTBalanceSheet(self):
        """Test FundamentalsIREITNODIRECTBalanceSheet"""
