...
class TestFundamentalsINOREITNODIRECTIncomeStatement(unittest.TestCase):
    """FundamentalsINOREITNODIRECTIncomeStatement unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FundamentalsINOREITNODIRECTIncomeStatement:
        """Test FundamentalsINOREITNODIRECTIncomeStatement
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FundamentalsINOREITNODIRECTIncomeStatement`
        """
        model = FundamentalsINOREITNODIRECTIncomeStatement()
        if include_optional:
            return FundamentalsINOREITNODIRECTIncomeStatement(
    ...
    def testFundamentalsINOREITNODIRECTIncomeStatement(self):
        """Test FundamentalsINOREITNODIRECTIncomeStatement"""
