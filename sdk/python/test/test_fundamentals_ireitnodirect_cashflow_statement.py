...
class TestFundamentalsIREITNODIRECTCashflowStatement(unittest.TestCase):
    """FundamentalsIREITNODIRECTCashflowStatement unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FundamentalsIREITNODIRECTCashflowStatement:
        """Test FundamentalsIREITNODIRECTCashflowStatement
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FundamentalsIREITNODIRECTCashflowStatement`
        """
        model = FundamentalsIREITNODIRECTCashflowStatement()
        if include_optional:
            return FundamentalsIREITNODIRECTCashflowStatement(
    ...
    def testFundamentalsIREITNODIRECTCashflowStatement(self):
        """Test FundamentalsIREITNODIRECTCashflowStatement"""
