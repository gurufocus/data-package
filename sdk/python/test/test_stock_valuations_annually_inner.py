...
class TestStockValuationsAnnuallyInner(unittest.TestCase):
    """StockValuationsAnnuallyInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StockValuationsAnnuallyInner:
        """Test StockValuationsAnnuallyInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StockValuationsAnnuallyInner`
        """
        model = StockValuationsAnnuallyInner()
        if include_optional:
    ...
    def testStockValuationsAnnuallyInner(self):
        """Test StockValuationsAnnuallyInner"""
