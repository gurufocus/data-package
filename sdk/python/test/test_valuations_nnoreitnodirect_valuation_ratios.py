...
class TestValuationsNNOREITNODIRECTValuationRatios(unittest.TestCase):
    """ValuationsNNOREITNODIRECTValuationRatios unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValuationsNNOREITNODIRECTValuationRatios:
        """Test ValuationsNNOREITNODIRECTValuationRatios
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValuationsNNOREITNODIRECTValuationRatios`
        """
        model = ValuationsNNOREITNODIRECTValuationRatios()
        if include_optional:
            return ValuationsNNOREITNODIRECTValuationRatios(
    ...
    def testValuationsNNOREITNODIRECTValuationRatios(self):
        """Test ValuationsNNOREITNODIRECTValuationRatios"""
