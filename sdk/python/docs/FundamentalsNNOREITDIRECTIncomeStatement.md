...
fundamentals_nnoreitdirect_income_statement_instance = FundamentalsNNOREITDIRECTIncomeStatement.from_json(json)
# print the JSON string representation of the object
print(FundamentalsNNOREITDIRECTIncomeStatement.to_json())

# convert the object into a dict
fundamentals_nnoreitdirect_income_statement_dict = fundamentals_nnoreitdirect_income_statement_instance.to_dict()
# create an instance of FundamentalsNNOREITDIRECTIncomeStatement from a dict
fundamentals_nnoreitdirect_income_statement_from_dict = FundamentalsNNOREITDIRECTIncomeStatement.from_dict(fundamentals_nnoreitdirect_income_statement_dict)
```
