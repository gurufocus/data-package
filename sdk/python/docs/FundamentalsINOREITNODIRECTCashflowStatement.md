...
json = "{}"
# create an instance of FundamentalsINOREITNODIRECTCashflowStatement from a JSON string
fundamentals_inoreitnodirect_cashflow_statement_instance = FundamentalsINOREITNODIRECTCashflowStatement.from_json(json)
# print the JSON string representation of the object
print(FundamentalsINOREITNODIRECTCashflowStatement.to_json())

# convert the object into a dict
fundamentals_inoreitnodirect_cashflow_statement_dict = fundamentals_inoreitnodirect_cashflow_statement_instance.to_dict()
# create an instance of FundamentalsINOREITNODIRECTCashflowStatement from a dict
fundamentals_inoreitnodirect_cashflow_statement_from_dict = FundamentalsINOREITNODIRECTCashflowStatement.from_dict(fundamentals_inoreitnodirect_cashflow_statement_dict)
```
