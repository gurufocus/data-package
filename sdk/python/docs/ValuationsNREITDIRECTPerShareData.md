...
**ffo_per_share** | **float** | &lt;p&gt;{{FFO}} (Funds from operations) refers to the figure used by real estate investment trusts (REITs) to define the cash flow from their operations. It is calculated by adding depreciation and amortization to earnings, subtracting any gains on sales.&lt;/p&gt; | [optional] 
...
json = "{}"
# create an instance of ValuationsNREITDIRECTPerShareData from a JSON string
valuations_nreitdirect_per_share_data_instance = ValuationsNREITDIRECTPerShareData.from_json(json)
# print the JSON string representation of the object
print(ValuationsNREITDIRECTPerShareData.to_json())

# convert the object into a dict
valuations_nreitdirect_per_share_data_dict = valuations_nreitdirect_per_share_data_instance.to_dict()
# create an instance of ValuationsNREITDIRECTPerShareData from a dict
valuations_nreitdirect_per_share_data_from_dict = ValuationsNREITDIRECTPerShareData.from_dict(valuations_nreitdirect_per_share_data_dict)
```
