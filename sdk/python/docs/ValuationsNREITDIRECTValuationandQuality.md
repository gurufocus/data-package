...
json = "{}"
# create an instance of ValuationsNREITDIRECTValuationandQuality from a JSON string
valuations_nreitdirect_valuationand_quality_instance = ValuationsNREITDIRECTValuationandQuality.from_json(json)
# print the JSON string representation of the object
print(ValuationsNREITDIRECTValuationandQuality.to_json())

# convert the object into a dict
valuations_nreitdirect_valuationand_quality_dict = valuations_nreitdirect_valuationand_quality_instance.to_dict()
# create an instance of ValuationsNREITDIRECTValuationandQuality from a dict
valuations_nreitdirect_valuationand_quality_from_dict = ValuationsNREITDIRECTValuationandQuality.from_dict(valuations_nreitdirect_valuationand_quality_dict)
```
