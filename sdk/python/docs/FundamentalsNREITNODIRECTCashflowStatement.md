...
fundamentals_nreitnodirect_cashflow_statement_instance = FundamentalsNREITNODIRECTCashflowStatement.from_json(json)
# print the JSON string representation of the object
print(FundamentalsNREITNODIRECTCashflowStatement.to_json())

# convert the object into a dict
fundamentals_nreitnodirect_cashflow_statement_dict = fundamentals_nreitnodirect_cashflow_statement_instance.to_dict()
# create an instance of FundamentalsNREITNODIRECTCashflowStatement from a dict
fundamentals_nreitnodirect_cashflow_statement_from_dict = FundamentalsNREITNODIRECTCashflowStatement.from_dict(fundamentals_nreitnodirect_cashflow_statement_dict)
```
