...
json = "{}"
# create an instance of FundamentalsNREITNODIRECTIncomeStatement from a JSON string
fundamentals_nreitnodirect_income_statement_instance = FundamentalsNREITNODIRECTIncomeStatement.from_json(json)
# print the JSON string representation of the object
print(FundamentalsNREITNODIRECTIncomeStatement.to_json())

# convert the object into a dict
fundamentals_nreitnodirect_income_statement_dict = fundamentals_nreitnodirect_income_statement_instance.to_dict()
# create an instance of FundamentalsNREITNODIRECTIncomeStatement from a dict
fundamentals_nreitnodirect_income_statement_from_dict = FundamentalsNREITNODIRECTIncomeStatement.from_dict(fundamentals_nreitnodirect_income_statement_dict)
```
