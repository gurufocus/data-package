...
**bs_share** | **float** |  | [optional] 
**buyback_yield** | **float** |  | [optional] 
**earnings_release_date** | **str** |  | [optional] 
**ebitda_5y_growth** | **float** | EBITDA per Share is the amount of Earnings Before Interest, Taxes, Depreciation, and Amortization (EBITDA) per outstanding share of the company&#39;s stock. | [optional] 
**enterprise_value** | **float** | Enterprise Value is calculated as the market cap plus debt and minority interest and preferred shares, minus total cash, cash equivalents, and marketable securities. | [optional] 
...
**filing_date_aor** | **str** |  | [optional] 
**forex_rate** | **float** | The month-end forex rates between the headquarter currency and the reporting currency | [optional] 
...
**graham_number** | **float** | Graham Number is a concept based on Ben Graham\\&#39;s conservative valuation of companies. Graham Number is calculated as follows:    Graham Number &#x3D; SquareRoot of (22.5 * {Tangible Book Value per Share} * {Earnings per Share})    &#x3D; SquareRoot of (22.5 * {Net Income} * {Total Equity}) / {Total Shares Outstanding} | [optional] 
**growth_per_share_ebitda** | **float** | EBITDA per Share is the amount of Earnings Before Interest, Taxes, Depreciation, and Amortization (EBITDA) per outstanding share of the company&#39;s stock. | [optional] 
**growth_per_share_eps** | **float** | The company&#39;s earnings per share growth year over year | [optional] 
**growth_revenue_per_share** | **float** | The company&#39;s revenue per share growth year over year | [optional] 
...
**intrinsic_value_projected_fcf** | **float** | The Discounted Free Cash Flow Screener focuses on Free Cash Flow (FCF) and Total Equity. These measures can be used to determine an intrinsic value estimate for a company. | [optional] 
...
**net_cash_per_share** | **float** | Equals cash and cash equivalents less total liabilities less minority interest | [optional] 
...
json = "{}"
# create an instance of ValuationsIREITNODIRECTValuationandQuality from a JSON string
valuations_ireitnodirect_valuationand_quality_instance = ValuationsIREITNODIRECTValuationandQuality.from_json(json)
# print the JSON string representation of the object
print(ValuationsIREITNODIRECTValuationandQuality.to_json())

# convert the object into a dict
valuations_ireitnodirect_valuationand_quality_dict = valuations_ireitnodirect_valuationand_quality_instance.to_dict()
# create an instance of ValuationsIREITNODIRECTValuationandQuality from a dict
valuations_ireitnodirect_valuationand_quality_from_dict = ValuationsIREITNODIRECTValuationandQuality.from_dict(valuations_ireitnodirect_valuationand_quality_dict)
```
