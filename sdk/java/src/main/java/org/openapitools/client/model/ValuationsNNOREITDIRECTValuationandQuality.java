...
public class ValuationsNNOREITDIRECTValuationandQuality {
  ...
  public ValuationsNNOREITDIRECTValuationandQuality() {
  }

  public ValuationsNNOREITDIRECTValuationandQuality beta(@javax.annotation.Nullable BigDecimal beta) {
    this.beta = beta;
    return this;
  }
  ...
  public ValuationsNNOREITDIRECTValuationandQuality bsShare(@javax.annotation.Nullable BigDecimal bsShare) {
  ...
  public ValuationsNNOREITDIRECTValuationandQuality buybackYield(@javax.annotation.Nullable BigDecimal buybackYield) {
  ...
  public ValuationsNNOREITDIRECTValuationandQuality cashRatio(@javax.annotation.Nullable BigDecimal cashRatio) {
  ...
  public ValuationsNNOREITDIRECTValuationandQuality currentRatio(@javax.annotation.Nullable BigDecimal currentRatio) {
  ...
  public ValuationsNNOREITDIRECTValuationandQuality earningsReleaseDate(@javax.annotation.Nullable String earningsReleaseDate) {
  ...
  public ValuationsNNOREITDIRECTValuationandQuality ebitda5yGrowth(@javax.annotation.Nullable BigDecimal ebitda5yGrowth) {
  ...
  public ValuationsNNOREITDIRECTValuationandQuality enterpriseValue(@javax.annotation.Nullable BigDecimal enterpriseValue) {
  ...
  public ValuationsNNOREITDIRECTValuationandQuality epv(@javax.annotation.Nullable BigDecimal epv) {
    this.epv = epv;
    return this;
  }
  ...
  public ValuationsNNOREITDIRECTValuationandQuality filingDate(@javax.annotation.Nullable String filingDate) {
  ...
  public ValuationsNNOREITDIRECTValuationandQuality filingDateAor(@javax.annotation.Nullable String filingDateAor) {
  ...
  public ValuationsNNOREITDIRECTValuationandQuality forexRate(@javax.annotation.Nullable BigDecimal forexRate) {
  ...
  public ValuationsNNOREITDIRECTValuationandQuality fscore(@javax.annotation.Nullable BigDecimal fscore) {
    this.fscore = fscore;
    return this;
  }
  ...
  public ValuationsNNOREITDIRECTValuationandQuality grahamNumber(@javax.annotation.Nullable BigDecimal grahamNumber) {
  ...
  public ValuationsNNOREITDIRECTValuationandQuality growthPerShareEbitda(@javax.annotation.Nullable BigDecimal growthPerShareEbitda) {
  ...
  public ValuationsNNOREITDIRECTValuationandQuality growthPerShareEps(@javax.annotation.Nullable BigDecimal growthPerShareEps) {
  ...
  public ValuationsNNOREITDIRECTValuationandQuality growthRevenuePerShare(@javax.annotation.Nullable BigDecimal growthRevenuePerShare) {
  ...
  public ValuationsNNOREITDIRECTValuationandQuality interestCoverage(@javax.annotation.Nullable BigDecimal interestCoverage) {
  ...
  public ValuationsNNOREITDIRECTValuationandQuality intrinsicValueProjectedFcf(@javax.annotation.Nullable BigDecimal intrinsicValueProjectedFcf) {
  ...
  public ValuationsNNOREITDIRECTValuationandQuality medpsvalue(@javax.annotation.Nullable BigDecimal medpsvalue) {
  ...
  public ValuationsNNOREITDIRECTValuationandQuality mktcap(@javax.annotation.Nullable BigDecimal mktcap) {
    this.mktcap = mktcap;
    return this;
  }
  ...
  public ValuationsNNOREITDIRECTValuationandQuality monthEndStockPrice(@javax.annotation.Nullable BigDecimal monthEndStockPrice) {
  ...
  public ValuationsNNOREITDIRECTValuationandQuality mscore(@javax.annotation.Nullable BigDecimal mscore) {
    this.mscore = mscore;
    return this;
  }
  ...
  public ValuationsNNOREITDIRECTValuationandQuality netCashPerShare(@javax.annotation.Nullable BigDecimal netCashPerShare) {
  ...
  public ValuationsNNOREITDIRECTValuationandQuality netCurrentAssetValue(@javax.annotation.Nullable BigDecimal netCurrentAssetValue) {
  ...
  public ValuationsNNOREITDIRECTValuationandQuality netNetWorkingCapital(@javax.annotation.Nullable BigDecimal netNetWorkingCapital) {
  ...
  public ValuationsNNOREITDIRECTValuationandQuality numberOfShareHolders(@javax.annotation.Nullable BigDecimal numberOfShareHolders) {
  ...
  public ValuationsNNOREITDIRECTValuationandQuality peterLynchFairValue(@javax.annotation.Nullable BigDecimal peterLynchFairValue) {
  ...
  public ValuationsNNOREITDIRECTValuationandQuality priceHigh(@javax.annotation.Nullable BigDecimal priceHigh) {
  ...
  public ValuationsNNOREITDIRECTValuationandQuality priceLow(@javax.annotation.Nullable BigDecimal priceLow) {
  ...
  public ValuationsNNOREITDIRECTValuationandQuality quickRatio(@javax.annotation.Nullable BigDecimal quickRatio) {
  ...
  public ValuationsNNOREITDIRECTValuationandQuality shareBuybackRatio(@javax.annotation.Nullable BigDecimal shareBuybackRatio) {
  ...
  public ValuationsNNOREITDIRECTValuationandQuality shareholderYield(@javax.annotation.Nullable BigDecimal shareholderYield) {
  ...
  public ValuationsNNOREITDIRECTValuationandQuality sharesBasic(@javax.annotation.Nullable BigDecimal sharesBasic) {
  ...
  public ValuationsNNOREITDIRECTValuationandQuality sloanRatio(@javax.annotation.Nullable BigDecimal sloanRatio) {
  ...
  public ValuationsNNOREITDIRECTValuationandQuality snoa(@javax.annotation.Nullable BigDecimal snoa) {
    this.snoa = snoa;
    return this;
  }
  ...
  public ValuationsNNOREITDIRECTValuationandQuality totalEmployeeNumber(@javax.annotation.Nullable BigDecimal totalEmployeeNumber) {
  ...
  public ValuationsNNOREITDIRECTValuationandQuality zscore(@javax.annotation.Nullable BigDecimal zscore) {
    this.zscore = zscore;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ValuationsNNOREITDIRECTValuationandQuality valuationsNNOREITDIRECTValuationandQuality = (ValuationsNNOREITDIRECTValuationandQuality) o;
    return Objects.equals(this.beta, valuationsNNOREITDIRECTValuationandQuality.beta) &&
        Objects.equals(this.bsShare, valuationsNNOREITDIRECTValuationandQuality.bsShare) &&
        Objects.equals(this.buybackYield, valuationsNNOREITDIRECTValuationandQuality.buybackYield) &&
        Objects.equals(this.cashRatio, valuationsNNOREITDIRECTValuationandQuality.cashRatio) &&
        Objects.equals(this.currentRatio, valuationsNNOREITDIRECTValuationandQuality.currentRatio) &&
        Objects.equals(this.earningsReleaseDate, valuationsNNOREITDIRECTValuationandQuality.earningsReleaseDate) &&
        Objects.equals(this.ebitda5yGrowth, valuationsNNOREITDIRECTValuationandQuality.ebitda5yGrowth) &&
        Objects.equals(this.enterpriseValue, valuationsNNOREITDIRECTValuationandQuality.enterpriseValue) &&
        Objects.equals(this.epv, valuationsNNOREITDIRECTValuationandQuality.epv) &&
        Objects.equals(this.filingDate, valuationsNNOREITDIRECTValuationandQuality.filingDate) &&
        Objects.equals(this.filingDateAor, valuationsNNOREITDIRECTValuationandQuality.filingDateAor) &&
        Objects.equals(this.forexRate, valuationsNNOREITDIRECTValuationandQuality.forexRate) &&
        Objects.equals(this.fscore, valuationsNNOREITDIRECTValuationandQuality.fscore) &&
        Objects.equals(this.grahamNumber, valuationsNNOREITDIRECTValuationandQuality.grahamNumber) &&
        Objects.equals(this.growthPerShareEbitda, valuationsNNOREITDIRECTValuationandQuality.growthPerShareEbitda) &&
        Objects.equals(this.growthPerShareEps, valuationsNNOREITDIRECTValuationandQuality.growthPerShareEps) &&
        Objects.equals(this.growthRevenuePerShare, valuationsNNOREITDIRECTValuationandQuality.growthRevenuePerShare) &&
        Objects.equals(this.interestCoverage, valuationsNNOREITDIRECTValuationandQuality.interestCoverage) &&
        Objects.equals(this.intrinsicValueProjectedFcf, valuationsNNOREITDIRECTValuationandQuality.intrinsicValueProjectedFcf) &&
        Objects.equals(this.medpsvalue, valuationsNNOREITDIRECTValuationandQuality.medpsvalue) &&
        Objects.equals(this.mktcap, valuationsNNOREITDIRECTValuationandQuality.mktcap) &&
        Objects.equals(this.monthEndStockPrice, valuationsNNOREITDIRECTValuationandQuality.monthEndStockPrice) &&
        Objects.equals(this.mscore, valuationsNNOREITDIRECTValuationandQuality.mscore) &&
        Objects.equals(this.netCashPerShare, valuationsNNOREITDIRECTValuationandQuality.netCashPerShare) &&
        Objects.equals(this.netCurrentAssetValue, valuationsNNOREITDIRECTValuationandQuality.netCurrentAssetValue) &&
        Objects.equals(this.netNetWorkingCapital, valuationsNNOREITDIRECTValuationandQuality.netNetWorkingCapital) &&
        Objects.equals(this.numberOfShareHolders, valuationsNNOREITDIRECTValuationandQuality.numberOfShareHolders) &&
        Objects.equals(this.peterLynchFairValue, valuationsNNOREITDIRECTValuationandQuality.peterLynchFairValue) &&
        Objects.equals(this.priceHigh, valuationsNNOREITDIRECTValuationandQuality.priceHigh) &&
        Objects.equals(this.priceLow, valuationsNNOREITDIRECTValuationandQuality.priceLow) &&
        Objects.equals(this.quickRatio, valuationsNNOREITDIRECTValuationandQuality.quickRatio) &&
        Objects.equals(this.shareBuybackRatio, valuationsNNOREITDIRECTValuationandQuality.shareBuybackRatio) &&
        Objects.equals(this.shareholderYield, valuationsNNOREITDIRECTValuationandQuality.shareholderYield) &&
        Objects.equals(this.sharesBasic, valuationsNNOREITDIRECTValuationandQuality.sharesBasic) &&
        Objects.equals(this.sloanRatio, valuationsNNOREITDIRECTValuationandQuality.sloanRatio) &&
        Objects.equals(this.snoa, valuationsNNOREITDIRECTValuationandQuality.snoa) &&
        Objects.equals(this.totalEmployeeNumber, valuationsNNOREITDIRECTValuationandQuality.totalEmployeeNumber) &&
        Objects.equals(this.zscore, valuationsNNOREITDIRECTValuationandQuality.zscore);
  }
  ...
  public String toString() {
    ...
    sb.append("class ValuationsNNOREITDIRECTValuationandQuality {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ValuationsNNOREITDIRECTValuationandQuality
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ValuationsNNOREITDIRECTValuationandQuality.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ValuationsNNOREITDIRECTValuationandQuality is not found in the empty JSON string", ValuationsNNOREITDIRECTValuationandQuality.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ValuationsNNOREITDIRECTValuationandQuality.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ValuationsNNOREITDIRECTValuationandQuality` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ValuationsNNOREITDIRECTValuationandQuality.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ValuationsNNOREITDIRECTValuationandQuality' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ValuationsNNOREITDIRECTValuationandQuality> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ValuationsNNOREITDIRECTValuationandQuality.class));

       return (TypeAdapter<T>) new TypeAdapter<ValuationsNNOREITDIRECTValuationandQuality>() {
           @Override
           public void write(JsonWriter out, ValuationsNNOREITDIRECTValuationandQuality value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ValuationsNNOREITDIRECTValuationandQuality read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ValuationsNNOREITDIRECTValuationandQuality given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ValuationsNNOREITDIRECTValuationandQuality
   * @throws IOException if the JSON string is invalid with respect to ValuationsNNOREITDIRECTValuationandQuality
   */
  public static ValuationsNNOREITDIRECTValuationandQuality fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ValuationsNNOREITDIRECTValuationandQuality.class);
  }

  /**
   * Convert an instance of ValuationsNNOREITDIRECTValuationandQuality to an JSON string
   *
   * @return JSON string
   */
