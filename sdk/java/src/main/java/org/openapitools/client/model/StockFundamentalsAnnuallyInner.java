...
public class StockFundamentalsAnnuallyInner extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(StockFundamentalsAnnuallyInner.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!StockFundamentalsAnnuallyInner.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'StockFundamentalsAnnuallyInner' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<StockFundamentalsAnnuallyInner>() {
                @Override
                public void write(JsonWriter out, StockFundamentalsAnnuallyInner value) throws IOException {
                ...
                @Override
                public StockFundamentalsAnnuallyInner read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        StockFundamentalsAnnuallyInner ret = new StockFundamentalsAnnuallyInner();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for StockFundamentalsAnnuallyInner: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public StockFundamentalsAnnuallyInner() {
        super("oneOf", Boolean.FALSE);
    }

    public StockFundamentalsAnnuallyInner(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return StockFundamentalsAnnuallyInner.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to StockFundamentalsAnnuallyInner
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for StockFundamentalsAnnuallyInner with oneOf schemas: FundamentalsINOREITNODIRECT, FundamentalsIREITNODIRECT, FundamentalsNNOREITDIRECT, FundamentalsNNOREITNODIRECT, FundamentalsNREITDIRECT, FundamentalsNREITNODIRECT. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of StockFundamentalsAnnuallyInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of StockFundamentalsAnnuallyInner
     * @throws IOException if the JSON string is invalid with respect to StockFundamentalsAnnuallyInner
     */
    public static StockFundamentalsAnnuallyInner fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, StockFundamentalsAnnuallyInner.class);
    }

    /**
     * Convert an instance of StockFundamentalsAnnuallyInner to an JSON string
     *
     * @return JSON string
     */
