...
public class ValuationsNREITDIRECTPerShareData {
  ...
  public ValuationsNREITDIRECTPerShareData() {
  }

  public ValuationsNREITDIRECTPerShareData bookValuePerShare(@javax.annotation.Nullable BigDecimal bookValuePerShare) {
  ...
  public ValuationsNREITDIRECTPerShareData cashFlowFromOperationsPerShare(@javax.annotation.Nullable BigDecimal cashFlowFromOperationsPerShare) {
  ...
  public ValuationsNREITDIRECTPerShareData cashPerShare(@javax.annotation.Nullable BigDecimal cashPerShare) {
  ...
  public ValuationsNREITDIRECTPerShareData dividendsPerShare(@javax.annotation.Nullable BigDecimal dividendsPerShare) {
  ...
  public ValuationsNREITDIRECTPerShareData earningPerShareDiluted(@javax.annotation.Nullable BigDecimal earningPerShareDiluted) {
  ...
  public ValuationsNREITDIRECTPerShareData ebitPerShare(@javax.annotation.Nullable BigDecimal ebitPerShare) {
  ...
  public ValuationsNREITDIRECTPerShareData ebitdaPerShare(@javax.annotation.Nullable BigDecimal ebitdaPerShare) {
  ...
  public ValuationsNREITDIRECTPerShareData epsWithoutNri(@javax.annotation.Nullable BigDecimal epsWithoutNri) {
  ...
  public ValuationsNREITDIRECTPerShareData ffoPerShare(@javax.annotation.Nullable BigDecimal ffoPerShare) {
  ...
  public ValuationsNREITDIRECTPerShareData freeCashFlowPerShare(@javax.annotation.Nullable BigDecimal freeCashFlowPerShare) {
  ...
  public ValuationsNREITDIRECTPerShareData monthEndStockPrice(@javax.annotation.Nullable BigDecimal monthEndStockPrice) {
  ...
  public ValuationsNREITDIRECTPerShareData ownerEarnings(@javax.annotation.Nullable BigDecimal ownerEarnings) {
  ...
  public ValuationsNREITDIRECTPerShareData revenuePerShare(@javax.annotation.Nullable BigDecimal revenuePerShare) {
  ...
  public ValuationsNREITDIRECTPerShareData tangiblesBookPerShare(@javax.annotation.Nullable BigDecimal tangiblesBookPerShare) {
  ...
  public ValuationsNREITDIRECTPerShareData totalDebtPerShare(@javax.annotation.Nullable BigDecimal totalDebtPerShare) {
  ...
  public boolean equals(Object o) {
    ...
    ValuationsNREITDIRECTPerShareData valuationsNREITDIRECTPerShareData = (ValuationsNREITDIRECTPerShareData) o;
    return Objects.equals(this.bookValuePerShare, valuationsNREITDIRECTPerShareData.bookValuePerShare) &&
        Objects.equals(this.cashFlowFromOperationsPerShare, valuationsNREITDIRECTPerShareData.cashFlowFromOperationsPerShare) &&
        Objects.equals(this.cashPerShare, valuationsNREITDIRECTPerShareData.cashPerShare) &&
        Objects.equals(this.dividendsPerShare, valuationsNREITDIRECTPerShareData.dividendsPerShare) &&
        Objects.equals(this.earningPerShareDiluted, valuationsNREITDIRECTPerShareData.earningPerShareDiluted) &&
        Objects.equals(this.ebitPerShare, valuationsNREITDIRECTPerShareData.ebitPerShare) &&
        Objects.equals(this.ebitdaPerShare, valuationsNREITDIRECTPerShareData.ebitdaPerShare) &&
        Objects.equals(this.epsWithoutNri, valuationsNREITDIRECTPerShareData.epsWithoutNri) &&
        Objects.equals(this.ffoPerShare, valuationsNREITDIRECTPerShareData.ffoPerShare) &&
        Objects.equals(this.freeCashFlowPerShare, valuationsNREITDIRECTPerShareData.freeCashFlowPerShare) &&
        Objects.equals(this.monthEndStockPrice, valuationsNREITDIRECTPerShareData.monthEndStockPrice) &&
        Objects.equals(this.ownerEarnings, valuationsNREITDIRECTPerShareData.ownerEarnings) &&
        Objects.equals(this.revenuePerShare, valuationsNREITDIRECTPerShareData.revenuePerShare) &&
        Objects.equals(this.tangiblesBookPerShare, valuationsNREITDIRECTPerShareData.tangiblesBookPerShare) &&
        Objects.equals(this.totalDebtPerShare, valuationsNREITDIRECTPerShareData.totalDebtPerShare);
  }
  ...
  public String toString() {
    ...
    sb.append("class ValuationsNREITDIRECTPerShareData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ValuationsNREITDIRECTPerShareData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ValuationsNREITDIRECTPerShareData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ValuationsNREITDIRECTPerShareData is not found in the empty JSON string", ValuationsNREITDIRECTPerShareData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ValuationsNREITDIRECTPerShareData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ValuationsNREITDIRECTPerShareData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ValuationsNREITDIRECTPerShareData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ValuationsNREITDIRECTPerShareData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ValuationsNREITDIRECTPerShareData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ValuationsNREITDIRECTPerShareData.class));

       return (TypeAdapter<T>) new TypeAdapter<ValuationsNREITDIRECTPerShareData>() {
           @Override
           public void write(JsonWriter out, ValuationsNREITDIRECTPerShareData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ValuationsNREITDIRECTPerShareData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ValuationsNREITDIRECTPerShareData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ValuationsNREITDIRECTPerShareData
   * @throws IOException if the JSON string is invalid with respect to ValuationsNREITDIRECTPerShareData
   */
  public static ValuationsNREITDIRECTPerShareData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ValuationsNREITDIRECTPerShareData.class);
  }

  /**
   * Convert an instance of ValuationsNREITDIRECTPerShareData to an JSON string
   *
   * @return JSON string
   */
