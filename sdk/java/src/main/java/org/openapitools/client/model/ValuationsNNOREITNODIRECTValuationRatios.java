...
public class ValuationsNNOREITNODIRECTValuationRatios {
  ...
  public ValuationsNNOREITNODIRECTValuationRatios() {
  }

  public ValuationsNNOREITNODIRECTValuationRatios cyclicallyAdjustedPbRatio(@javax.annotation.Nullable BigDecimal cyclicallyAdjustedPbRatio) {
  ...
  public ValuationsNNOREITNODIRECTValuationRatios cyclicallyAdjustedPriceToFcf(@javax.annotation.Nullable BigDecimal cyclicallyAdjustedPriceToFcf) {
  ...
  public ValuationsNNOREITNODIRECTValuationRatios cyclicallyAdjustedPsRatio(@javax.annotation.Nullable BigDecimal cyclicallyAdjustedPsRatio) {
  ...
  public ValuationsNNOREITNODIRECTValuationRatios earningYieldGreenblatt(@javax.annotation.Nullable BigDecimal earningYieldGreenblatt) {
  ...
  public ValuationsNNOREITNODIRECTValuationRatios enterpriseValueToEbit(@javax.annotation.Nullable BigDecimal enterpriseValueToEbit) {
  ...
  public ValuationsNNOREITNODIRECTValuationRatios enterpriseValueToEbitda(@javax.annotation.Nullable BigDecimal enterpriseValueToEbitda) {
  ...
  public ValuationsNNOREITNODIRECTValuationRatios enterpriseValueToFcf(@javax.annotation.Nullable BigDecimal enterpriseValueToFcf) {
  ...
  public ValuationsNNOREITNODIRECTValuationRatios enterpriseValueToRevenue(@javax.annotation.Nullable BigDecimal enterpriseValueToRevenue) {
  ...
  public ValuationsNNOREITNODIRECTValuationRatios fcfYield(@javax.annotation.Nullable BigDecimal fcfYield) {
  ...
  public ValuationsNNOREITNODIRECTValuationRatios pbRatio(@javax.annotation.Nullable BigDecimal pbRatio) {
  ...
  public ValuationsNNOREITNODIRECTValuationRatios peRatio(@javax.annotation.Nullable BigDecimal peRatio) {
  ...
  public ValuationsNNOREITNODIRECTValuationRatios pegRatio(@javax.annotation.Nullable BigDecimal pegRatio) {
  ...
  public ValuationsNNOREITNODIRECTValuationRatios penri(@javax.annotation.Nullable BigDecimal penri) {
    this.penri = penri;
    return this;
  }
  ...
  public ValuationsNNOREITNODIRECTValuationRatios priceToFreeCashFlow(@javax.annotation.Nullable BigDecimal priceToFreeCashFlow) {
  ...
  public ValuationsNNOREITNODIRECTValuationRatios priceToOperatingCashFlow(@javax.annotation.Nullable BigDecimal priceToOperatingCashFlow) {
  ...
  public ValuationsNNOREITNODIRECTValuationRatios priceToOwnerEarnings(@javax.annotation.Nullable BigDecimal priceToOwnerEarnings) {
  ...
  public ValuationsNNOREITNODIRECTValuationRatios priceToTangibleBook(@javax.annotation.Nullable BigDecimal priceToTangibleBook) {
  ...
  public ValuationsNNOREITNODIRECTValuationRatios psRatio(@javax.annotation.Nullable BigDecimal psRatio) {
  ...
  public ValuationsNNOREITNODIRECTValuationRatios rateOfReturnValue(@javax.annotation.Nullable BigDecimal rateOfReturnValue) {
  ...
  public ValuationsNNOREITNODIRECTValuationRatios shillerPeRatio(@javax.annotation.Nullable BigDecimal shillerPeRatio) {
  ...
  public ValuationsNNOREITNODIRECTValuationRatios yield(@javax.annotation.Nullable BigDecimal yield) {
    this.yield = yield;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ValuationsNNOREITNODIRECTValuationRatios valuationsNNOREITNODIRECTValuationRatios = (ValuationsNNOREITNODIRECTValuationRatios) o;
    return Objects.equals(this.cyclicallyAdjustedPbRatio, valuationsNNOREITNODIRECTValuationRatios.cyclicallyAdjustedPbRatio) &&
        Objects.equals(this.cyclicallyAdjustedPriceToFcf, valuationsNNOREITNODIRECTValuationRatios.cyclicallyAdjustedPriceToFcf) &&
        Objects.equals(this.cyclicallyAdjustedPsRatio, valuationsNNOREITNODIRECTValuationRatios.cyclicallyAdjustedPsRatio) &&
        Objects.equals(this.earningYieldGreenblatt, valuationsNNOREITNODIRECTValuationRatios.earningYieldGreenblatt) &&
        Objects.equals(this.enterpriseValueToEbit, valuationsNNOREITNODIRECTValuationRatios.enterpriseValueToEbit) &&
        Objects.equals(this.enterpriseValueToEbitda, valuationsNNOREITNODIRECTValuationRatios.enterpriseValueToEbitda) &&
        Objects.equals(this.enterpriseValueToFcf, valuationsNNOREITNODIRECTValuationRatios.enterpriseValueToFcf) &&
        Objects.equals(this.enterpriseValueToRevenue, valuationsNNOREITNODIRECTValuationRatios.enterpriseValueToRevenue) &&
        Objects.equals(this.fcfYield, valuationsNNOREITNODIRECTValuationRatios.fcfYield) &&
        Objects.equals(this.pbRatio, valuationsNNOREITNODIRECTValuationRatios.pbRatio) &&
        Objects.equals(this.peRatio, valuationsNNOREITNODIRECTValuationRatios.peRatio) &&
        Objects.equals(this.pegRatio, valuationsNNOREITNODIRECTValuationRatios.pegRatio) &&
        Objects.equals(this.penri, valuationsNNOREITNODIRECTValuationRatios.penri) &&
        Objects.equals(this.priceToFreeCashFlow, valuationsNNOREITNODIRECTValuationRatios.priceToFreeCashFlow) &&
        Objects.equals(this.priceToOperatingCashFlow, valuationsNNOREITNODIRECTValuationRatios.priceToOperatingCashFlow) &&
        Objects.equals(this.priceToOwnerEarnings, valuationsNNOREITNODIRECTValuationRatios.priceToOwnerEarnings) &&
        Objects.equals(this.priceToTangibleBook, valuationsNNOREITNODIRECTValuationRatios.priceToTangibleBook) &&
        Objects.equals(this.psRatio, valuationsNNOREITNODIRECTValuationRatios.psRatio) &&
        Objects.equals(this.rateOfReturnValue, valuationsNNOREITNODIRECTValuationRatios.rateOfReturnValue) &&
        Objects.equals(this.shillerPeRatio, valuationsNNOREITNODIRECTValuationRatios.shillerPeRatio) &&
        Objects.equals(this.yield, valuationsNNOREITNODIRECTValuationRatios.yield);
  }
  ...
  public String toString() {
    ...
    sb.append("class ValuationsNNOREITNODIRECTValuationRatios {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ValuationsNNOREITNODIRECTValuationRatios
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ValuationsNNOREITNODIRECTValuationRatios.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ValuationsNNOREITNODIRECTValuationRatios is not found in the empty JSON string", ValuationsNNOREITNODIRECTValuationRatios.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ValuationsNNOREITNODIRECTValuationRatios.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ValuationsNNOREITNODIRECTValuationRatios` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ValuationsNNOREITNODIRECTValuationRatios.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ValuationsNNOREITNODIRECTValuationRatios' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ValuationsNNOREITNODIRECTValuationRatios> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ValuationsNNOREITNODIRECTValuationRatios.class));

       return (TypeAdapter<T>) new TypeAdapter<ValuationsNNOREITNODIRECTValuationRatios>() {
           @Override
           public void write(JsonWriter out, ValuationsNNOREITNODIRECTValuationRatios value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ValuationsNNOREITNODIRECTValuationRatios read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ValuationsNNOREITNODIRECTValuationRatios given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ValuationsNNOREITNODIRECTValuationRatios
   * @throws IOException if the JSON string is invalid with respect to ValuationsNNOREITNODIRECTValuationRatios
   */
  public static ValuationsNNOREITNODIRECTValuationRatios fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ValuationsNNOREITNODIRECTValuationRatios.class);
  }

  /**
   * Convert an instance of ValuationsNNOREITNODIRECTValuationRatios to an JSON string
   *
   * @return JSON string
   */
