...
public class ValuationsNNOREITNODIRECTPerShareData {
  ...
  public ValuationsNNOREITNODIRECTPerShareData() {
  }

  public ValuationsNNOREITNODIRECTPerShareData bookValuePerShare(@javax.annotation.Nullable BigDecimal bookValuePerShare) {
  ...
  public ValuationsNNOREITNODIRECTPerShareData cashFlowFromOperationsPerShare(@javax.annotation.Nullable BigDecimal cashFlowFromOperationsPerShare) {
  ...
  public ValuationsNNOREITNODIRECTPerShareData cashPerShare(@javax.annotation.Nullable BigDecimal cashPerShare) {
  ...
  public ValuationsNNOREITNODIRECTPerShareData dividendsPerShare(@javax.annotation.Nullable BigDecimal dividendsPerShare) {
  ...
  public ValuationsNNOREITNODIRECTPerShareData earningPerShareDiluted(@javax.annotation.Nullable BigDecimal earningPerShareDiluted) {
  ...
  public ValuationsNNOREITNODIRECTPerShareData ebitPerShare(@javax.annotation.Nullable BigDecimal ebitPerShare) {
  ...
  public ValuationsNNOREITNODIRECTPerShareData ebitdaPerShare(@javax.annotation.Nullable BigDecimal ebitdaPerShare) {
  ...
  public ValuationsNNOREITNODIRECTPerShareData epsWithoutNri(@javax.annotation.Nullable BigDecimal epsWithoutNri) {
  ...
  public ValuationsNNOREITNODIRECTPerShareData freeCashFlowPerShare(@javax.annotation.Nullable BigDecimal freeCashFlowPerShare) {
  ...
  public ValuationsNNOREITNODIRECTPerShareData monthEndStockPrice(@javax.annotation.Nullable BigDecimal monthEndStockPrice) {
  ...
  public ValuationsNNOREITNODIRECTPerShareData ownerEarnings(@javax.annotation.Nullable BigDecimal ownerEarnings) {
  ...
  public ValuationsNNOREITNODIRECTPerShareData revenuePerShare(@javax.annotation.Nullable BigDecimal revenuePerShare) {
  ...
  public ValuationsNNOREITNODIRECTPerShareData tangiblesBookPerShare(@javax.annotation.Nullable BigDecimal tangiblesBookPerShare) {
  ...
  public ValuationsNNOREITNODIRECTPerShareData totalDebtPerShare(@javax.annotation.Nullable BigDecimal totalDebtPerShare) {
  ...
  public boolean equals(Object o) {
    ...
    ValuationsNNOREITNODIRECTPerShareData valuationsNNOREITNODIRECTPerShareData = (ValuationsNNOREITNODIRECTPerShareData) o;
    return Objects.equals(this.bookValuePerShare, valuationsNNOREITNODIRECTPerShareData.bookValuePerShare) &&
        Objects.equals(this.cashFlowFromOperationsPerShare, valuationsNNOREITNODIRECTPerShareData.cashFlowFromOperationsPerShare) &&
        Objects.equals(this.cashPerShare, valuationsNNOREITNODIRECTPerShareData.cashPerShare) &&
        Objects.equals(this.dividendsPerShare, valuationsNNOREITNODIRECTPerShareData.dividendsPerShare) &&
        Objects.equals(this.earningPerShareDiluted, valuationsNNOREITNODIRECTPerShareData.earningPerShareDiluted) &&
        Objects.equals(this.ebitPerShare, valuationsNNOREITNODIRECTPerShareData.ebitPerShare) &&
        Objects.equals(this.ebitdaPerShare, valuationsNNOREITNODIRECTPerShareData.ebitdaPerShare) &&
        Objects.equals(this.epsWithoutNri, valuationsNNOREITNODIRECTPerShareData.epsWithoutNri) &&
        Objects.equals(this.freeCashFlowPerShare, valuationsNNOREITNODIRECTPerShareData.freeCashFlowPerShare) &&
        Objects.equals(this.monthEndStockPrice, valuationsNNOREITNODIRECTPerShareData.monthEndStockPrice) &&
        Objects.equals(this.ownerEarnings, valuationsNNOREITNODIRECTPerShareData.ownerEarnings) &&
        Objects.equals(this.revenuePerShare, valuationsNNOREITNODIRECTPerShareData.revenuePerShare) &&
        Objects.equals(this.tangiblesBookPerShare, valuationsNNOREITNODIRECTPerShareData.tangiblesBookPerShare) &&
        Objects.equals(this.totalDebtPerShare, valuationsNNOREITNODIRECTPerShareData.totalDebtPerShare);
  }
  ...
  public String toString() {
    ...
    sb.append("class ValuationsNNOREITNODIRECTPerShareData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ValuationsNNOREITNODIRECTPerShareData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ValuationsNNOREITNODIRECTPerShareData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ValuationsNNOREITNODIRECTPerShareData is not found in the empty JSON string", ValuationsNNOREITNODIRECTPerShareData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ValuationsNNOREITNODIRECTPerShareData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ValuationsNNOREITNODIRECTPerShareData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ValuationsNNOREITNODIRECTPerShareData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ValuationsNNOREITNODIRECTPerShareData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ValuationsNNOREITNODIRECTPerShareData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ValuationsNNOREITNODIRECTPerShareData.class));

       return (TypeAdapter<T>) new TypeAdapter<ValuationsNNOREITNODIRECTPerShareData>() {
           @Override
           public void write(JsonWriter out, ValuationsNNOREITNODIRECTPerShareData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ValuationsNNOREITNODIRECTPerShareData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ValuationsNNOREITNODIRECTPerShareData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ValuationsNNOREITNODIRECTPerShareData
   * @throws IOException if the JSON string is invalid with respect to ValuationsNNOREITNODIRECTPerShareData
   */
  public static ValuationsNNOREITNODIRECTPerShareData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ValuationsNNOREITNODIRECTPerShareData.class);
  }

  /**
   * Convert an instance of ValuationsNNOREITNODIRECTPerShareData to an JSON string
   *
   * @return JSON string
   */
