...
public class ValuationsINOREITNODIRECTPerShareData {
  ...
  public ValuationsINOREITNODIRECTPerShareData() {
  }

  public ValuationsINOREITNODIRECTPerShareData bookValuePerShare(@javax.annotation.Nullable BigDecimal bookValuePerShare) {
  ...
  public ValuationsINOREITNODIRECTPerShareData cashFlowFromOperationsPerShare(@javax.annotation.Nullable BigDecimal cashFlowFromOperationsPerShare) {
  ...
  public ValuationsINOREITNODIRECTPerShareData cashPerShare(@javax.annotation.Nullable BigDecimal cashPerShare) {
  ...
  public ValuationsINOREITNODIRECTPerShareData dividendsPerShare(@javax.annotation.Nullable BigDecimal dividendsPerShare) {
  ...
  public ValuationsINOREITNODIRECTPerShareData earningPerShareDiluted(@javax.annotation.Nullable BigDecimal earningPerShareDiluted) {
  ...
  public ValuationsINOREITNODIRECTPerShareData ebitPerShare(@javax.annotation.Nullable BigDecimal ebitPerShare) {
  ...
  public ValuationsINOREITNODIRECTPerShareData ebitdaPerShare(@javax.annotation.Nullable BigDecimal ebitdaPerShare) {
  ...
  public ValuationsINOREITNODIRECTPerShareData epsWithoutNri(@javax.annotation.Nullable BigDecimal epsWithoutNri) {
  ...
  public ValuationsINOREITNODIRECTPerShareData freeCashFlowPerShare(@javax.annotation.Nullable BigDecimal freeCashFlowPerShare) {
  ...
  public ValuationsINOREITNODIRECTPerShareData monthEndStockPrice(@javax.annotation.Nullable BigDecimal monthEndStockPrice) {
  ...
  public ValuationsINOREITNODIRECTPerShareData ownerEarnings(@javax.annotation.Nullable BigDecimal ownerEarnings) {
  ...
  public ValuationsINOREITNODIRECTPerShareData revenuePerShare(@javax.annotation.Nullable BigDecimal revenuePerShare) {
  ...
  public ValuationsINOREITNODIRECTPerShareData tangiblesBookPerShare(@javax.annotation.Nullable BigDecimal tangiblesBookPerShare) {
  ...
  public ValuationsINOREITNODIRECTPerShareData totalDebtPerShare(@javax.annotation.Nullable BigDecimal totalDebtPerShare) {
  ...
  public boolean equals(Object o) {
    ...
    ValuationsINOREITNODIRECTPerShareData valuationsINOREITNODIRECTPerShareData = (ValuationsINOREITNODIRECTPerShareData) o;
    return Objects.equals(this.bookValuePerShare, valuationsINOREITNODIRECTPerShareData.bookValuePerShare) &&
        Objects.equals(this.cashFlowFromOperationsPerShare, valuationsINOREITNODIRECTPerShareData.cashFlowFromOperationsPerShare) &&
        Objects.equals(this.cashPerShare, valuationsINOREITNODIRECTPerShareData.cashPerShare) &&
        Objects.equals(this.dividendsPerShare, valuationsINOREITNODIRECTPerShareData.dividendsPerShare) &&
        Objects.equals(this.earningPerShareDiluted, valuationsINOREITNODIRECTPerShareData.earningPerShareDiluted) &&
        Objects.equals(this.ebitPerShare, valuationsINOREITNODIRECTPerShareData.ebitPerShare) &&
        Objects.equals(this.ebitdaPerShare, valuationsINOREITNODIRECTPerShareData.ebitdaPerShare) &&
        Objects.equals(this.epsWithoutNri, valuationsINOREITNODIRECTPerShareData.epsWithoutNri) &&
        Objects.equals(this.freeCashFlowPerShare, valuationsINOREITNODIRECTPerShareData.freeCashFlowPerShare) &&
        Objects.equals(this.monthEndStockPrice, valuationsINOREITNODIRECTPerShareData.monthEndStockPrice) &&
        Objects.equals(this.ownerEarnings, valuationsINOREITNODIRECTPerShareData.ownerEarnings) &&
        Objects.equals(this.revenuePerShare, valuationsINOREITNODIRECTPerShareData.revenuePerShare) &&
        Objects.equals(this.tangiblesBookPerShare, valuationsINOREITNODIRECTPerShareData.tangiblesBookPerShare) &&
        Objects.equals(this.totalDebtPerShare, valuationsINOREITNODIRECTPerShareData.totalDebtPerShare);
  }
  ...
  public String toString() {
    ...
    sb.append("class ValuationsINOREITNODIRECTPerShareData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ValuationsINOREITNODIRECTPerShareData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ValuationsINOREITNODIRECTPerShareData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ValuationsINOREITNODIRECTPerShareData is not found in the empty JSON string", ValuationsINOREITNODIRECTPerShareData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ValuationsINOREITNODIRECTPerShareData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ValuationsINOREITNODIRECTPerShareData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ValuationsINOREITNODIRECTPerShareData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ValuationsINOREITNODIRECTPerShareData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ValuationsINOREITNODIRECTPerShareData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ValuationsINOREITNODIRECTPerShareData.class));

       return (TypeAdapter<T>) new TypeAdapter<ValuationsINOREITNODIRECTPerShareData>() {
           @Override
           public void write(JsonWriter out, ValuationsINOREITNODIRECTPerShareData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ValuationsINOREITNODIRECTPerShareData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ValuationsINOREITNODIRECTPerShareData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ValuationsINOREITNODIRECTPerShareData
   * @throws IOException if the JSON string is invalid with respect to ValuationsINOREITNODIRECTPerShareData
   */
  public static ValuationsINOREITNODIRECTPerShareData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ValuationsINOREITNODIRECTPerShareData.class);
  }

  /**
   * Convert an instance of ValuationsINOREITNODIRECTPerShareData to an JSON string
   *
   * @return JSON string
   */
