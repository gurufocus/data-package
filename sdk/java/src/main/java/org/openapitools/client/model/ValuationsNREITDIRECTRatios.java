...
public class ValuationsNREITDIRECTRatios {
  ...
  public ValuationsNREITDIRECTRatios() {
  }

  public ValuationsNREITDIRECTRatios capexToOperatingCashFlow(@javax.annotation.Nullable BigDecimal capexToOperatingCashFlow) {
  ...
  public ValuationsNREITDIRECTRatios capexToOperatingIncome(@javax.annotation.Nullable BigDecimal capexToOperatingIncome) {
  ...
  public ValuationsNREITDIRECTRatios capexToRevenue(@javax.annotation.Nullable BigDecimal capexToRevenue) {
  ...
  public ValuationsNREITDIRECTRatios cashConversionCycle(@javax.annotation.Nullable BigDecimal cashConversionCycle) {
  ...
  public ValuationsNREITDIRECTRatios costOfGoodsSoldToRevenue(@javax.annotation.Nullable BigDecimal costOfGoodsSoldToRevenue) {
  ...
  public ValuationsNREITDIRECTRatios daysInventory(@javax.annotation.Nullable BigDecimal daysInventory) {
  ...
  public ValuationsNREITDIRECTRatios daysPayable(@javax.annotation.Nullable BigDecimal daysPayable) {
  ...
  public ValuationsNREITDIRECTRatios daysSalesOutstanding(@javax.annotation.Nullable BigDecimal daysSalesOutstanding) {
  ...
  public ValuationsNREITDIRECTRatios debtToAsset(@javax.annotation.Nullable BigDecimal debtToAsset) {
  ...
  public ValuationsNREITDIRECTRatios debtToEquity(@javax.annotation.Nullable BigDecimal debtToEquity) {
  ...
  public ValuationsNREITDIRECTRatios degreeOfFinancialLeverage(@javax.annotation.Nullable BigDecimal degreeOfFinancialLeverage) {
  ...
  public ValuationsNREITDIRECTRatios degreeOfOperatingLeverage(@javax.annotation.Nullable BigDecimal degreeOfOperatingLeverage) {
  ...
  public ValuationsNREITDIRECTRatios dividendToFfo(@javax.annotation.Nullable BigDecimal dividendToFfo) {
  ...
  public ValuationsNREITDIRECTRatios ebitdaMargin(@javax.annotation.Nullable BigDecimal ebitdaMargin) {
  ...
  public ValuationsNREITDIRECTRatios effectiveInterestRate(@javax.annotation.Nullable BigDecimal effectiveInterestRate) {
  ...
  public ValuationsNREITDIRECTRatios equityToAsset(@javax.annotation.Nullable BigDecimal equityToAsset) {
  ...
  public ValuationsNREITDIRECTRatios fcfMargin(@javax.annotation.Nullable BigDecimal fcfMargin) {
  ...
  public ValuationsNREITDIRECTRatios grossMargin(@javax.annotation.Nullable BigDecimal grossMargin) {
  ...
  public ValuationsNREITDIRECTRatios grossProfitToAsset(@javax.annotation.Nullable BigDecimal grossProfitToAsset) {
  ...
  public ValuationsNREITDIRECTRatios inventoryToRevenue(@javax.annotation.Nullable BigDecimal inventoryToRevenue) {
  ...
  public ValuationsNREITDIRECTRatios inventoryTurnover(@javax.annotation.Nullable BigDecimal inventoryTurnover) {
  ...
  public ValuationsNREITDIRECTRatios liabilitiesToAssets(@javax.annotation.Nullable BigDecimal liabilitiesToAssets) {
  ...
  public ValuationsNREITDIRECTRatios netMargin(@javax.annotation.Nullable BigDecimal netMargin) {
  ...
  public ValuationsNREITDIRECTRatios operatingMargin(@javax.annotation.Nullable BigDecimal operatingMargin) {
  ...
  public ValuationsNREITDIRECTRatios payout(@javax.annotation.Nullable BigDecimal payout) {
    this.payout = payout;
    return this;
  }
  ...
  public ValuationsNREITDIRECTRatios rd2rev(@javax.annotation.Nullable BigDecimal rd2rev) {
    this.rd2rev = rd2rev;
    return this;
  }
  ...
  public ValuationsNREITDIRECTRatios receivablesTurnover(@javax.annotation.Nullable BigDecimal receivablesTurnover) {
  ...
  public ValuationsNREITDIRECTRatios returnOnTangibleAsset(@javax.annotation.Nullable BigDecimal returnOnTangibleAsset) {
  ...
  public ValuationsNREITDIRECTRatios returnOnTangibleEquity(@javax.annotation.Nullable BigDecimal returnOnTangibleEquity) {
  ...
  public ValuationsNREITDIRECTRatios roa(@javax.annotation.Nullable BigDecimal roa) {
    this.roa = roa;
    return this;
  }
  ...
  public ValuationsNREITDIRECTRatios rocJoel(@javax.annotation.Nullable BigDecimal rocJoel) {
  ...
  public ValuationsNREITDIRECTRatios roce(@javax.annotation.Nullable BigDecimal roce) {
    this.roce = roce;
    return this;
  }
  ...
  public ValuationsNREITDIRECTRatios roe(@javax.annotation.Nullable BigDecimal roe) {
    this.roe = roe;
    return this;
  }
  ...
  public ValuationsNREITDIRECTRatios roeAdj(@javax.annotation.Nullable BigDecimal roeAdj) {
    this.roeAdj = roeAdj;
    return this;
  }
  ...
  public ValuationsNREITDIRECTRatios roic(@javax.annotation.Nullable BigDecimal roic) {
    this.roic = roic;
    return this;
  }
  ...
  public ValuationsNREITDIRECTRatios roiic1y(@javax.annotation.Nullable BigDecimal roiic1y) {
  ...
  public ValuationsNREITDIRECTRatios rore5y(@javax.annotation.Nullable BigDecimal rore5y) {
    this.rore5y = rore5y;
    return this;
  }
  ...
  public ValuationsNREITDIRECTRatios turnover(@javax.annotation.Nullable BigDecimal turnover) {
  ...
  public ValuationsNREITDIRECTRatios wacc(@javax.annotation.Nullable BigDecimal wacc) {
    this.wacc = wacc;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ValuationsNREITDIRECTRatios valuationsNREITDIRECTRatios = (ValuationsNREITDIRECTRatios) o;
    return Objects.equals(this.capexToOperatingCashFlow, valuationsNREITDIRECTRatios.capexToOperatingCashFlow) &&
        Objects.equals(this.capexToOperatingIncome, valuationsNREITDIRECTRatios.capexToOperatingIncome) &&
        Objects.equals(this.capexToRevenue, valuationsNREITDIRECTRatios.capexToRevenue) &&
        Objects.equals(this.cashConversionCycle, valuationsNREITDIRECTRatios.cashConversionCycle) &&
        Objects.equals(this.costOfGoodsSoldToRevenue, valuationsNREITDIRECTRatios.costOfGoodsSoldToRevenue) &&
        Objects.equals(this.daysInventory, valuationsNREITDIRECTRatios.daysInventory) &&
        Objects.equals(this.daysPayable, valuationsNREITDIRECTRatios.daysPayable) &&
        Objects.equals(this.daysSalesOutstanding, valuationsNREITDIRECTRatios.daysSalesOutstanding) &&
        Objects.equals(this.debtToAsset, valuationsNREITDIRECTRatios.debtToAsset) &&
        Objects.equals(this.debtToEquity, valuationsNREITDIRECTRatios.debtToEquity) &&
        Objects.equals(this.degreeOfFinancialLeverage, valuationsNREITDIRECTRatios.degreeOfFinancialLeverage) &&
        Objects.equals(this.degreeOfOperatingLeverage, valuationsNREITDIRECTRatios.degreeOfOperatingLeverage) &&
        Objects.equals(this.dividendToFfo, valuationsNREITDIRECTRatios.dividendToFfo) &&
        Objects.equals(this.ebitdaMargin, valuationsNREITDIRECTRatios.ebitdaMargin) &&
        Objects.equals(this.effectiveInterestRate, valuationsNREITDIRECTRatios.effectiveInterestRate) &&
        Objects.equals(this.equityToAsset, valuationsNREITDIRECTRatios.equityToAsset) &&
        Objects.equals(this.fcfMargin, valuationsNREITDIRECTRatios.fcfMargin) &&
        Objects.equals(this.grossMargin, valuationsNREITDIRECTRatios.grossMargin) &&
        Objects.equals(this.grossProfitToAsset, valuationsNREITDIRECTRatios.grossProfitToAsset) &&
        Objects.equals(this.inventoryToRevenue, valuationsNREITDIRECTRatios.inventoryToRevenue) &&
        Objects.equals(this.inventoryTurnover, valuationsNREITDIRECTRatios.inventoryTurnover) &&
        Objects.equals(this.liabilitiesToAssets, valuationsNREITDIRECTRatios.liabilitiesToAssets) &&
        Objects.equals(this.netMargin, valuationsNREITDIRECTRatios.netMargin) &&
        Objects.equals(this.operatingMargin, valuationsNREITDIRECTRatios.operatingMargin) &&
        Objects.equals(this.payout, valuationsNREITDIRECTRatios.payout) &&
        Objects.equals(this.rd2rev, valuationsNREITDIRECTRatios.rd2rev) &&
        Objects.equals(this.receivablesTurnover, valuationsNREITDIRECTRatios.receivablesTurnover) &&
        Objects.equals(this.returnOnTangibleAsset, valuationsNREITDIRECTRatios.returnOnTangibleAsset) &&
        Objects.equals(this.returnOnTangibleEquity, valuationsNREITDIRECTRatios.returnOnTangibleEquity) &&
        Objects.equals(this.roa, valuationsNREITDIRECTRatios.roa) &&
        Objects.equals(this.rocJoel, valuationsNREITDIRECTRatios.rocJoel) &&
        Objects.equals(this.roce, valuationsNREITDIRECTRatios.roce) &&
        Objects.equals(this.roe, valuationsNREITDIRECTRatios.roe) &&
        Objects.equals(this.roeAdj, valuationsNREITDIRECTRatios.roeAdj) &&
        Objects.equals(this.roic, valuationsNREITDIRECTRatios.roic) &&
        Objects.equals(this.roiic1y, valuationsNREITDIRECTRatios.roiic1y) &&
        Objects.equals(this.rore5y, valuationsNREITDIRECTRatios.rore5y) &&
        Objects.equals(this.turnover, valuationsNREITDIRECTRatios.turnover) &&
        Objects.equals(this.wacc, valuationsNREITDIRECTRatios.wacc);
  }
  ...
  public String toString() {
    ...
    sb.append("class ValuationsNREITDIRECTRatios {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ValuationsNREITDIRECTRatios
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ValuationsNREITDIRECTRatios.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ValuationsNREITDIRECTRatios is not found in the empty JSON string", ValuationsNREITDIRECTRatios.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ValuationsNREITDIRECTRatios.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ValuationsNREITDIRECTRatios` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ValuationsNREITDIRECTRatios.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ValuationsNREITDIRECTRatios' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ValuationsNREITDIRECTRatios> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ValuationsNREITDIRECTRatios.class));

       return (TypeAdapter<T>) new TypeAdapter<ValuationsNREITDIRECTRatios>() {
           @Override
           public void write(JsonWriter out, ValuationsNREITDIRECTRatios value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ValuationsNREITDIRECTRatios read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ValuationsNREITDIRECTRatios given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ValuationsNREITDIRECTRatios
   * @throws IOException if the JSON string is invalid with respect to ValuationsNREITDIRECTRatios
   */
  public static ValuationsNREITDIRECTRatios fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ValuationsNREITDIRECTRatios.class);
  }

  /**
   * Convert an instance of ValuationsNREITDIRECTRatios to an JSON string
   *
   * @return JSON string
   */
