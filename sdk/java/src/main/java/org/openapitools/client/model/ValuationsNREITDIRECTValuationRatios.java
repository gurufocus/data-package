...
public class ValuationsNREITDIRECTValuationRatios {
  ...
  public ValuationsNREITDIRECTValuationRatios() {
  }

  public ValuationsNREITDIRECTValuationRatios cyclicallyAdjustedPbRatio(@javax.annotation.Nullable BigDecimal cyclicallyAdjustedPbRatio) {
  ...
  public ValuationsNREITDIRECTValuationRatios cyclicallyAdjustedPriceToFcf(@javax.annotation.Nullable BigDecimal cyclicallyAdjustedPriceToFcf) {
  ...
  public ValuationsNREITDIRECTValuationRatios cyclicallyAdjustedPsRatio(@javax.annotation.Nullable BigDecimal cyclicallyAdjustedPsRatio) {
  ...
  public ValuationsNREITDIRECTValuationRatios earningYieldGreenblatt(@javax.annotation.Nullable BigDecimal earningYieldGreenblatt) {
  ...
  public ValuationsNREITDIRECTValuationRatios enterpriseValueToEbit(@javax.annotation.Nullable BigDecimal enterpriseValueToEbit) {
  ...
  public ValuationsNREITDIRECTValuationRatios enterpriseValueToEbitda(@javax.annotation.Nullable BigDecimal enterpriseValueToEbitda) {
  ...
  public ValuationsNREITDIRECTValuationRatios enterpriseValueToFcf(@javax.annotation.Nullable BigDecimal enterpriseValueToFcf) {
  ...
  public ValuationsNREITDIRECTValuationRatios enterpriseValueToRevenue(@javax.annotation.Nullable BigDecimal enterpriseValueToRevenue) {
  ...
  public ValuationsNREITDIRECTValuationRatios fcfYield(@javax.annotation.Nullable BigDecimal fcfYield) {
  ...
  public ValuationsNREITDIRECTValuationRatios pbRatio(@javax.annotation.Nullable BigDecimal pbRatio) {
  ...
  public ValuationsNREITDIRECTValuationRatios peRatio(@javax.annotation.Nullable BigDecimal peRatio) {
  ...
  public ValuationsNREITDIRECTValuationRatios pegRatio(@javax.annotation.Nullable BigDecimal pegRatio) {
  ...
  public ValuationsNREITDIRECTValuationRatios penri(@javax.annotation.Nullable BigDecimal penri) {
    this.penri = penri;
    return this;
  }
  ...
  public ValuationsNREITDIRECTValuationRatios priceToFfo(@javax.annotation.Nullable BigDecimal priceToFfo) {
  ...
  public ValuationsNREITDIRECTValuationRatios priceToFreeCashFlow(@javax.annotation.Nullable BigDecimal priceToFreeCashFlow) {
  ...
  public ValuationsNREITDIRECTValuationRatios priceToOperatingCashFlow(@javax.annotation.Nullable BigDecimal priceToOperatingCashFlow) {
  ...
  public ValuationsNREITDIRECTValuationRatios priceToOwnerEarnings(@javax.annotation.Nullable BigDecimal priceToOwnerEarnings) {
  ...
  public ValuationsNREITDIRECTValuationRatios priceToTangibleBook(@javax.annotation.Nullable BigDecimal priceToTangibleBook) {
  ...
  public ValuationsNREITDIRECTValuationRatios psRatio(@javax.annotation.Nullable BigDecimal psRatio) {
  ...
  public ValuationsNREITDIRECTValuationRatios rateOfReturnValue(@javax.annotation.Nullable BigDecimal rateOfReturnValue) {
  ...
  public ValuationsNREITDIRECTValuationRatios shillerPeRatio(@javax.annotation.Nullable BigDecimal shillerPeRatio) {
  ...
  public ValuationsNREITDIRECTValuationRatios yield(@javax.annotation.Nullable BigDecimal yield) {
    this.yield = yield;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ValuationsNREITDIRECTValuationRatios valuationsNREITDIRECTValuationRatios = (ValuationsNREITDIRECTValuationRatios) o;
    return Objects.equals(this.cyclicallyAdjustedPbRatio, valuationsNREITDIRECTValuationRatios.cyclicallyAdjustedPbRatio) &&
        Objects.equals(this.cyclicallyAdjustedPriceToFcf, valuationsNREITDIRECTValuationRatios.cyclicallyAdjustedPriceToFcf) &&
        Objects.equals(this.cyclicallyAdjustedPsRatio, valuationsNREITDIRECTValuationRatios.cyclicallyAdjustedPsRatio) &&
        Objects.equals(this.earningYieldGreenblatt, valuationsNREITDIRECTValuationRatios.earningYieldGreenblatt) &&
        Objects.equals(this.enterpriseValueToEbit, valuationsNREITDIRECTValuationRatios.enterpriseValueToEbit) &&
        Objects.equals(this.enterpriseValueToEbitda, valuationsNREITDIRECTValuationRatios.enterpriseValueToEbitda) &&
        Objects.equals(this.enterpriseValueToFcf, valuationsNREITDIRECTValuationRatios.enterpriseValueToFcf) &&
        Objects.equals(this.enterpriseValueToRevenue, valuationsNREITDIRECTValuationRatios.enterpriseValueToRevenue) &&
        Objects.equals(this.fcfYield, valuationsNREITDIRECTValuationRatios.fcfYield) &&
        Objects.equals(this.pbRatio, valuationsNREITDIRECTValuationRatios.pbRatio) &&
        Objects.equals(this.peRatio, valuationsNREITDIRECTValuationRatios.peRatio) &&
        Objects.equals(this.pegRatio, valuationsNREITDIRECTValuationRatios.pegRatio) &&
        Objects.equals(this.penri, valuationsNREITDIRECTValuationRatios.penri) &&
        Objects.equals(this.priceToFfo, valuationsNREITDIRECTValuationRatios.priceToFfo) &&
        Objects.equals(this.priceToFreeCashFlow, valuationsNREITDIRECTValuationRatios.priceToFreeCashFlow) &&
        Objects.equals(this.priceToOperatingCashFlow, valuationsNREITDIRECTValuationRatios.priceToOperatingCashFlow) &&
        Objects.equals(this.priceToOwnerEarnings, valuationsNREITDIRECTValuationRatios.priceToOwnerEarnings) &&
        Objects.equals(this.priceToTangibleBook, valuationsNREITDIRECTValuationRatios.priceToTangibleBook) &&
        Objects.equals(this.psRatio, valuationsNREITDIRECTValuationRatios.psRatio) &&
        Objects.equals(this.rateOfReturnValue, valuationsNREITDIRECTValuationRatios.rateOfReturnValue) &&
        Objects.equals(this.shillerPeRatio, valuationsNREITDIRECTValuationRatios.shillerPeRatio) &&
        Objects.equals(this.yield, valuationsNREITDIRECTValuationRatios.yield);
  }
  ...
  public String toString() {
    ...
    sb.append("class ValuationsNREITDIRECTValuationRatios {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ValuationsNREITDIRECTValuationRatios
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ValuationsNREITDIRECTValuationRatios.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ValuationsNREITDIRECTValuationRatios is not found in the empty JSON string", ValuationsNREITDIRECTValuationRatios.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ValuationsNREITDIRECTValuationRatios.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ValuationsNREITDIRECTValuationRatios` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ValuationsNREITDIRECTValuationRatios.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ValuationsNREITDIRECTValuationRatios' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ValuationsNREITDIRECTValuationRatios> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ValuationsNREITDIRECTValuationRatios.class));

       return (TypeAdapter<T>) new TypeAdapter<ValuationsNREITDIRECTValuationRatios>() {
           @Override
           public void write(JsonWriter out, ValuationsNREITDIRECTValuationRatios value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ValuationsNREITDIRECTValuationRatios read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ValuationsNREITDIRECTValuationRatios given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ValuationsNREITDIRECTValuationRatios
   * @throws IOException if the JSON string is invalid with respect to ValuationsNREITDIRECTValuationRatios
   */
  public static ValuationsNREITDIRECTValuationRatios fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ValuationsNREITDIRECTValuationRatios.class);
  }

  /**
   * Convert an instance of ValuationsNREITDIRECTValuationRatios to an JSON string
   *
   * @return JSON string
   */
