...
public class ValuationsINOREITNODIRECTRatios {
  ...
  public ValuationsINOREITNODIRECTRatios() {
  }

  public ValuationsINOREITNODIRECTRatios capexToOperatingCashFlow(@javax.annotation.Nullable BigDecimal capexToOperatingCashFlow) {
  ...
  public ValuationsINOREITNODIRECTRatios capexToRevenue(@javax.annotation.Nullable BigDecimal capexToRevenue) {
  ...
  public ValuationsINOREITNODIRECTRatios debtToAsset(@javax.annotation.Nullable BigDecimal debtToAsset) {
  ...
  public ValuationsINOREITNODIRECTRatios debtToEquity(@javax.annotation.Nullable BigDecimal debtToEquity) {
  ...
  public ValuationsINOREITNODIRECTRatios degreeOfFinancialLeverage(@javax.annotation.Nullable BigDecimal degreeOfFinancialLeverage) {
  ...
  public ValuationsINOREITNODIRECTRatios degreeOfOperatingLeverage(@javax.annotation.Nullable BigDecimal degreeOfOperatingLeverage) {
  ...
  public ValuationsINOREITNODIRECTRatios ebitdaMargin(@javax.annotation.Nullable BigDecimal ebitdaMargin) {
  ...
  public ValuationsINOREITNODIRECTRatios effectiveInterestRate(@javax.annotation.Nullable BigDecimal effectiveInterestRate) {
  ...
  public ValuationsINOREITNODIRECTRatios equityToAsset(@javax.annotation.Nullable BigDecimal equityToAsset) {
  ...
  public ValuationsINOREITNODIRECTRatios fcfMargin(@javax.annotation.Nullable BigDecimal fcfMargin) {
  ...
  public ValuationsINOREITNODIRECTRatios liabilitiesToAssets(@javax.annotation.Nullable BigDecimal liabilitiesToAssets) {
  ...
  public ValuationsINOREITNODIRECTRatios netMargin(@javax.annotation.Nullable BigDecimal netMargin) {
  ...
  public ValuationsINOREITNODIRECTRatios payout(@javax.annotation.Nullable BigDecimal payout) {
    this.payout = payout;
    return this;
  }
  ...
  public ValuationsINOREITNODIRECTRatios returnOnTangibleAsset(@javax.annotation.Nullable BigDecimal returnOnTangibleAsset) {
  ...
  public ValuationsINOREITNODIRECTRatios returnOnTangibleEquity(@javax.annotation.Nullable BigDecimal returnOnTangibleEquity) {
  ...
  public ValuationsINOREITNODIRECTRatios roa(@javax.annotation.Nullable BigDecimal roa) {
    this.roa = roa;
    return this;
  }
  ...
  public ValuationsINOREITNODIRECTRatios roe(@javax.annotation.Nullable BigDecimal roe) {
    this.roe = roe;
    return this;
  }
  ...
  public ValuationsINOREITNODIRECTRatios roeAdj(@javax.annotation.Nullable BigDecimal roeAdj) {
    this.roeAdj = roeAdj;
    return this;
  }
  ...
  public ValuationsINOREITNODIRECTRatios roic(@javax.annotation.Nullable BigDecimal roic) {
    this.roic = roic;
    return this;
  }
  ...
  public ValuationsINOREITNODIRECTRatios roiic1y(@javax.annotation.Nullable BigDecimal roiic1y) {
  ...
  public ValuationsINOREITNODIRECTRatios rore5y(@javax.annotation.Nullable BigDecimal rore5y) {
    this.rore5y = rore5y;
    return this;
  }
  ...
  public ValuationsINOREITNODIRECTRatios turnover(@javax.annotation.Nullable BigDecimal turnover) {
  ...
  public ValuationsINOREITNODIRECTRatios wacc(@javax.annotation.Nullable BigDecimal wacc) {
    this.wacc = wacc;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ValuationsINOREITNODIRECTRatios valuationsINOREITNODIRECTRatios = (ValuationsINOREITNODIRECTRatios) o;
    return Objects.equals(this.capexToOperatingCashFlow, valuationsINOREITNODIRECTRatios.capexToOperatingCashFlow) &&
        Objects.equals(this.capexToRevenue, valuationsINOREITNODIRECTRatios.capexToRevenue) &&
        Objects.equals(this.debtToAsset, valuationsINOREITNODIRECTRatios.debtToAsset) &&
        Objects.equals(this.debtToEquity, valuationsINOREITNODIRECTRatios.debtToEquity) &&
        Objects.equals(this.degreeOfFinancialLeverage, valuationsINOREITNODIRECTRatios.degreeOfFinancialLeverage) &&
        Objects.equals(this.degreeOfOperatingLeverage, valuationsINOREITNODIRECTRatios.degreeOfOperatingLeverage) &&
        Objects.equals(this.ebitdaMargin, valuationsINOREITNODIRECTRatios.ebitdaMargin) &&
        Objects.equals(this.effectiveInterestRate, valuationsINOREITNODIRECTRatios.effectiveInterestRate) &&
        Objects.equals(this.equityToAsset, valuationsINOREITNODIRECTRatios.equityToAsset) &&
        Objects.equals(this.fcfMargin, valuationsINOREITNODIRECTRatios.fcfMargin) &&
        Objects.equals(this.liabilitiesToAssets, valuationsINOREITNODIRECTRatios.liabilitiesToAssets) &&
        Objects.equals(this.netMargin, valuationsINOREITNODIRECTRatios.netMargin) &&
        Objects.equals(this.payout, valuationsINOREITNODIRECTRatios.payout) &&
        Objects.equals(this.returnOnTangibleAsset, valuationsINOREITNODIRECTRatios.returnOnTangibleAsset) &&
        Objects.equals(this.returnOnTangibleEquity, valuationsINOREITNODIRECTRatios.returnOnTangibleEquity) &&
        Objects.equals(this.roa, valuationsINOREITNODIRECTRatios.roa) &&
        Objects.equals(this.roe, valuationsINOREITNODIRECTRatios.roe) &&
        Objects.equals(this.roeAdj, valuationsINOREITNODIRECTRatios.roeAdj) &&
        Objects.equals(this.roic, valuationsINOREITNODIRECTRatios.roic) &&
        Objects.equals(this.roiic1y, valuationsINOREITNODIRECTRatios.roiic1y) &&
        Objects.equals(this.rore5y, valuationsINOREITNODIRECTRatios.rore5y) &&
        Objects.equals(this.turnover, valuationsINOREITNODIRECTRatios.turnover) &&
        Objects.equals(this.wacc, valuationsINOREITNODIRECTRatios.wacc);
  }
  ...
  public String toString() {
    ...
    sb.append("class ValuationsINOREITNODIRECTRatios {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ValuationsINOREITNODIRECTRatios
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ValuationsINOREITNODIRECTRatios.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ValuationsINOREITNODIRECTRatios is not found in the empty JSON string", ValuationsINOREITNODIRECTRatios.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ValuationsINOREITNODIRECTRatios.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ValuationsINOREITNODIRECTRatios` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ValuationsINOREITNODIRECTRatios.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ValuationsINOREITNODIRECTRatios' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ValuationsINOREITNODIRECTRatios> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ValuationsINOREITNODIRECTRatios.class));

       return (TypeAdapter<T>) new TypeAdapter<ValuationsINOREITNODIRECTRatios>() {
           @Override
           public void write(JsonWriter out, ValuationsINOREITNODIRECTRatios value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ValuationsINOREITNODIRECTRatios read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ValuationsINOREITNODIRECTRatios given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ValuationsINOREITNODIRECTRatios
   * @throws IOException if the JSON string is invalid with respect to ValuationsINOREITNODIRECTRatios
   */
  public static ValuationsINOREITNODIRECTRatios fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ValuationsINOREITNODIRECTRatios.class);
  }

  /**
   * Convert an instance of ValuationsINOREITNODIRECTRatios to an JSON string
   *
   * @return JSON string
   */
