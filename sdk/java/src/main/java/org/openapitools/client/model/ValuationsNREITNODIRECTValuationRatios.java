...
public class ValuationsNREITNODIRECTValuationRatios {
  ...
  public ValuationsNREITNODIRECTValuationRatios() {
  }

  public ValuationsNREITNODIRECTValuationRatios cyclicallyAdjustedPbRatio(@javax.annotation.Nullable BigDecimal cyclicallyAdjustedPbRatio) {
  ...
  public ValuationsNREITNODIRECTValuationRatios cyclicallyAdjustedPriceToFcf(@javax.annotation.Nullable BigDecimal cyclicallyAdjustedPriceToFcf) {
  ...
  public ValuationsNREITNODIRECTValuationRatios cyclicallyAdjustedPsRatio(@javax.annotation.Nullable BigDecimal cyclicallyAdjustedPsRatio) {
  ...
  public ValuationsNREITNODIRECTValuationRatios earningYieldGreenblatt(@javax.annotation.Nullable BigDecimal earningYieldGreenblatt) {
  ...
  public ValuationsNREITNODIRECTValuationRatios enterpriseValueToEbit(@javax.annotation.Nullable BigDecimal enterpriseValueToEbit) {
  ...
  public ValuationsNREITNODIRECTValuationRatios enterpriseValueToEbitda(@javax.annotation.Nullable BigDecimal enterpriseValueToEbitda) {
  ...
  public ValuationsNREITNODIRECTValuationRatios enterpriseValueToFcf(@javax.annotation.Nullable BigDecimal enterpriseValueToFcf) {
  ...
  public ValuationsNREITNODIRECTValuationRatios enterpriseValueToRevenue(@javax.annotation.Nullable BigDecimal enterpriseValueToRevenue) {
  ...
  public ValuationsNREITNODIRECTValuationRatios fcfYield(@javax.annotation.Nullable BigDecimal fcfYield) {
  ...
  public ValuationsNREITNODIRECTValuationRatios pbRatio(@javax.annotation.Nullable BigDecimal pbRatio) {
  ...
  public ValuationsNREITNODIRECTValuationRatios peRatio(@javax.annotation.Nullable BigDecimal peRatio) {
  ...
  public ValuationsNREITNODIRECTValuationRatios pegRatio(@javax.annotation.Nullable BigDecimal pegRatio) {
  ...
  public ValuationsNREITNODIRECTValuationRatios penri(@javax.annotation.Nullable BigDecimal penri) {
    this.penri = penri;
    return this;
  }
  ...
  public ValuationsNREITNODIRECTValuationRatios priceToFfo(@javax.annotation.Nullable BigDecimal priceToFfo) {
  ...
  public ValuationsNREITNODIRECTValuationRatios priceToFreeCashFlow(@javax.annotation.Nullable BigDecimal priceToFreeCashFlow) {
  ...
  public ValuationsNREITNODIRECTValuationRatios priceToOperatingCashFlow(@javax.annotation.Nullable BigDecimal priceToOperatingCashFlow) {
  ...
  public ValuationsNREITNODIRECTValuationRatios priceToOwnerEarnings(@javax.annotation.Nullable BigDecimal priceToOwnerEarnings) {
  ...
  public ValuationsNREITNODIRECTValuationRatios priceToTangibleBook(@javax.annotation.Nullable BigDecimal priceToTangibleBook) {
  ...
  public ValuationsNREITNODIRECTValuationRatios psRatio(@javax.annotation.Nullable BigDecimal psRatio) {
  ...
  public ValuationsNREITNODIRECTValuationRatios rateOfReturnValue(@javax.annotation.Nullable BigDecimal rateOfReturnValue) {
  ...
  public ValuationsNREITNODIRECTValuationRatios shillerPeRatio(@javax.annotation.Nullable BigDecimal shillerPeRatio) {
  ...
  public ValuationsNREITNODIRECTValuationRatios yield(@javax.annotation.Nullable BigDecimal yield) {
    this.yield = yield;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ValuationsNREITNODIRECTValuationRatios valuationsNREITNODIRECTValuationRatios = (ValuationsNREITNODIRECTValuationRatios) o;
    return Objects.equals(this.cyclicallyAdjustedPbRatio, valuationsNREITNODIRECTValuationRatios.cyclicallyAdjustedPbRatio) &&
        Objects.equals(this.cyclicallyAdjustedPriceToFcf, valuationsNREITNODIRECTValuationRatios.cyclicallyAdjustedPriceToFcf) &&
        Objects.equals(this.cyclicallyAdjustedPsRatio, valuationsNREITNODIRECTValuationRatios.cyclicallyAdjustedPsRatio) &&
        Objects.equals(this.earningYieldGreenblatt, valuationsNREITNODIRECTValuationRatios.earningYieldGreenblatt) &&
        Objects.equals(this.enterpriseValueToEbit, valuationsNREITNODIRECTValuationRatios.enterpriseValueToEbit) &&
        Objects.equals(this.enterpriseValueToEbitda, valuationsNREITNODIRECTValuationRatios.enterpriseValueToEbitda) &&
        Objects.equals(this.enterpriseValueToFcf, valuationsNREITNODIRECTValuationRatios.enterpriseValueToFcf) &&
        Objects.equals(this.enterpriseValueToRevenue, valuationsNREITNODIRECTValuationRatios.enterpriseValueToRevenue) &&
        Objects.equals(this.fcfYield, valuationsNREITNODIRECTValuationRatios.fcfYield) &&
        Objects.equals(this.pbRatio, valuationsNREITNODIRECTValuationRatios.pbRatio) &&
        Objects.equals(this.peRatio, valuationsNREITNODIRECTValuationRatios.peRatio) &&
        Objects.equals(this.pegRatio, valuationsNREITNODIRECTValuationRatios.pegRatio) &&
        Objects.equals(this.penri, valuationsNREITNODIRECTValuationRatios.penri) &&
        Objects.equals(this.priceToFfo, valuationsNREITNODIRECTValuationRatios.priceToFfo) &&
        Objects.equals(this.priceToFreeCashFlow, valuationsNREITNODIRECTValuationRatios.priceToFreeCashFlow) &&
        Objects.equals(this.priceToOperatingCashFlow, valuationsNREITNODIRECTValuationRatios.priceToOperatingCashFlow) &&
        Objects.equals(this.priceToOwnerEarnings, valuationsNREITNODIRECTValuationRatios.priceToOwnerEarnings) &&
        Objects.equals(this.priceToTangibleBook, valuationsNREITNODIRECTValuationRatios.priceToTangibleBook) &&
        Objects.equals(this.psRatio, valuationsNREITNODIRECTValuationRatios.psRatio) &&
        Objects.equals(this.rateOfReturnValue, valuationsNREITNODIRECTValuationRatios.rateOfReturnValue) &&
        Objects.equals(this.shillerPeRatio, valuationsNREITNODIRECTValuationRatios.shillerPeRatio) &&
        Objects.equals(this.yield, valuationsNREITNODIRECTValuationRatios.yield);
  }
  ...
  public String toString() {
    ...
    sb.append("class ValuationsNREITNODIRECTValuationRatios {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ValuationsNREITNODIRECTValuationRatios
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ValuationsNREITNODIRECTValuationRatios.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ValuationsNREITNODIRECTValuationRatios is not found in the empty JSON string", ValuationsNREITNODIRECTValuationRatios.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ValuationsNREITNODIRECTValuationRatios.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ValuationsNREITNODIRECTValuationRatios` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ValuationsNREITNODIRECTValuationRatios.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ValuationsNREITNODIRECTValuationRatios' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ValuationsNREITNODIRECTValuationRatios> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ValuationsNREITNODIRECTValuationRatios.class));

       return (TypeAdapter<T>) new TypeAdapter<ValuationsNREITNODIRECTValuationRatios>() {
           @Override
           public void write(JsonWriter out, ValuationsNREITNODIRECTValuationRatios value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ValuationsNREITNODIRECTValuationRatios read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ValuationsNREITNODIRECTValuationRatios given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ValuationsNREITNODIRECTValuationRatios
   * @throws IOException if the JSON string is invalid with respect to ValuationsNREITNODIRECTValuationRatios
   */
  public static ValuationsNREITNODIRECTValuationRatios fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ValuationsNREITNODIRECTValuationRatios.class);
  }

  /**
   * Convert an instance of ValuationsNREITNODIRECTValuationRatios to an JSON string
   *
   * @return JSON string
   */
