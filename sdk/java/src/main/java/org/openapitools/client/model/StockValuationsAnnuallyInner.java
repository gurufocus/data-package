...
public class StockValuationsAnnuallyInner extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(StockValuationsAnnuallyInner.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!StockValuationsAnnuallyInner.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'StockValuationsAnnuallyInner' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<StockValuationsAnnuallyInner>() {
                @Override
                public void write(JsonWriter out, StockValuationsAnnuallyInner value) throws IOException {
                ...
                @Override
                public StockValuationsAnnuallyInner read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        StockValuationsAnnuallyInner ret = new StockValuationsAnnuallyInner();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for StockValuationsAnnuallyInner: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public StockValuationsAnnuallyInner() {
        super("oneOf", Boolean.FALSE);
    }

    public StockValuationsAnnuallyInner(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return StockValuationsAnnuallyInner.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to StockValuationsAnnuallyInner
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for StockValuationsAnnuallyInner with oneOf schemas: ValuationsINOREITNODIRECT, ValuationsIREITNODIRECT, ValuationsNNOREITDIRECT, ValuationsNNOREITNODIRECT, ValuationsNREITDIRECT, ValuationsNREITNODIRECT. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of StockValuationsAnnuallyInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of StockValuationsAnnuallyInner
     * @throws IOException if the JSON string is invalid with respect to StockValuationsAnnuallyInner
     */
    public static StockValuationsAnnuallyInner fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, StockValuationsAnnuallyInner.class);
    }

    /**
     * Convert an instance of StockValuationsAnnuallyInner to an JSON string
     *
     * @return JSON string
     */
