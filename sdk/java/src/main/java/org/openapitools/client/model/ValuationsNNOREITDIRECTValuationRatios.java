...
public class ValuationsNNOREITDIRECTValuationRatios {
  ...
  public ValuationsNNOREITDIRECTValuationRatios() {
  }

  public ValuationsNNOREITDIRECTValuationRatios cyclicallyAdjustedPbRatio(@javax.annotation.Nullable BigDecimal cyclicallyAdjustedPbRatio) {
  ...
  public ValuationsNNOREITDIRECTValuationRatios cyclicallyAdjustedPriceToFcf(@javax.annotation.Nullable BigDecimal cyclicallyAdjustedPriceToFcf) {
  ...
  public ValuationsNNOREITDIRECTValuationRatios cyclicallyAdjustedPsRatio(@javax.annotation.Nullable BigDecimal cyclicallyAdjustedPsRatio) {
  ...
  public ValuationsNNOREITDIRECTValuationRatios earningYieldGreenblatt(@javax.annotation.Nullable BigDecimal earningYieldGreenblatt) {
  ...
  public ValuationsNNOREITDIRECTValuationRatios enterpriseValueToEbit(@javax.annotation.Nullable BigDecimal enterpriseValueToEbit) {
  ...
  public ValuationsNNOREITDIRECTValuationRatios enterpriseValueToEbitda(@javax.annotation.Nullable BigDecimal enterpriseValueToEbitda) {
  ...
  public ValuationsNNOREITDIRECTValuationRatios enterpriseValueToFcf(@javax.annotation.Nullable BigDecimal enterpriseValueToFcf) {
  ...
  public ValuationsNNOREITDIRECTValuationRatios enterpriseValueToRevenue(@javax.annotation.Nullable BigDecimal enterpriseValueToRevenue) {
  ...
  public ValuationsNNOREITDIRECTValuationRatios fcfYield(@javax.annotation.Nullable BigDecimal fcfYield) {
  ...
  public ValuationsNNOREITDIRECTValuationRatios pbRatio(@javax.annotation.Nullable BigDecimal pbRatio) {
  ...
  public ValuationsNNOREITDIRECTValuationRatios peRatio(@javax.annotation.Nullable BigDecimal peRatio) {
  ...
  public ValuationsNNOREITDIRECTValuationRatios pegRatio(@javax.annotation.Nullable BigDecimal pegRatio) {
  ...
  public ValuationsNNOREITDIRECTValuationRatios penri(@javax.annotation.Nullable BigDecimal penri) {
    this.penri = penri;
    return this;
  }
  ...
  public ValuationsNNOREITDIRECTValuationRatios priceToFreeCashFlow(@javax.annotation.Nullable BigDecimal priceToFreeCashFlow) {
  ...
  public ValuationsNNOREITDIRECTValuationRatios priceToOperatingCashFlow(@javax.annotation.Nullable BigDecimal priceToOperatingCashFlow) {
  ...
  public ValuationsNNOREITDIRECTValuationRatios priceToOwnerEarnings(@javax.annotation.Nullable BigDecimal priceToOwnerEarnings) {
  ...
  public ValuationsNNOREITDIRECTValuationRatios priceToTangibleBook(@javax.annotation.Nullable BigDecimal priceToTangibleBook) {
  ...
  public ValuationsNNOREITDIRECTValuationRatios psRatio(@javax.annotation.Nullable BigDecimal psRatio) {
  ...
  public ValuationsNNOREITDIRECTValuationRatios rateOfReturnValue(@javax.annotation.Nullable BigDecimal rateOfReturnValue) {
  ...
  public ValuationsNNOREITDIRECTValuationRatios shillerPeRatio(@javax.annotation.Nullable BigDecimal shillerPeRatio) {
  ...
  public ValuationsNNOREITDIRECTValuationRatios yield(@javax.annotation.Nullable BigDecimal yield) {
    this.yield = yield;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ValuationsNNOREITDIRECTValuationRatios valuationsNNOREITDIRECTValuationRatios = (ValuationsNNOREITDIRECTValuationRatios) o;
    return Objects.equals(this.cyclicallyAdjustedPbRatio, valuationsNNOREITDIRECTValuationRatios.cyclicallyAdjustedPbRatio) &&
        Objects.equals(this.cyclicallyAdjustedPriceToFcf, valuationsNNOREITDIRECTValuationRatios.cyclicallyAdjustedPriceToFcf) &&
        Objects.equals(this.cyclicallyAdjustedPsRatio, valuationsNNOREITDIRECTValuationRatios.cyclicallyAdjustedPsRatio) &&
        Objects.equals(this.earningYieldGreenblatt, valuationsNNOREITDIRECTValuationRatios.earningYieldGreenblatt) &&
        Objects.equals(this.enterpriseValueToEbit, valuationsNNOREITDIRECTValuationRatios.enterpriseValueToEbit) &&
        Objects.equals(this.enterpriseValueToEbitda, valuationsNNOREITDIRECTValuationRatios.enterpriseValueToEbitda) &&
        Objects.equals(this.enterpriseValueToFcf, valuationsNNOREITDIRECTValuationRatios.enterpriseValueToFcf) &&
        Objects.equals(this.enterpriseValueToRevenue, valuationsNNOREITDIRECTValuationRatios.enterpriseValueToRevenue) &&
        Objects.equals(this.fcfYield, valuationsNNOREITDIRECTValuationRatios.fcfYield) &&
        Objects.equals(this.pbRatio, valuationsNNOREITDIRECTValuationRatios.pbRatio) &&
        Objects.equals(this.peRatio, valuationsNNOREITDIRECTValuationRatios.peRatio) &&
        Objects.equals(this.pegRatio, valuationsNNOREITDIRECTValuationRatios.pegRatio) &&
        Objects.equals(this.penri, valuationsNNOREITDIRECTValuationRatios.penri) &&
        Objects.equals(this.priceToFreeCashFlow, valuationsNNOREITDIRECTValuationRatios.priceToFreeCashFlow) &&
        Objects.equals(this.priceToOperatingCashFlow, valuationsNNOREITDIRECTValuationRatios.priceToOperatingCashFlow) &&
        Objects.equals(this.priceToOwnerEarnings, valuationsNNOREITDIRECTValuationRatios.priceToOwnerEarnings) &&
        Objects.equals(this.priceToTangibleBook, valuationsNNOREITDIRECTValuationRatios.priceToTangibleBook) &&
        Objects.equals(this.psRatio, valuationsNNOREITDIRECTValuationRatios.psRatio) &&
        Objects.equals(this.rateOfReturnValue, valuationsNNOREITDIRECTValuationRatios.rateOfReturnValue) &&
        Objects.equals(this.shillerPeRatio, valuationsNNOREITDIRECTValuationRatios.shillerPeRatio) &&
        Objects.equals(this.yield, valuationsNNOREITDIRECTValuationRatios.yield);
  }
  ...
  public String toString() {
    ...
    sb.append("class ValuationsNNOREITDIRECTValuationRatios {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ValuationsNNOREITDIRECTValuationRatios
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ValuationsNNOREITDIRECTValuationRatios.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ValuationsNNOREITDIRECTValuationRatios is not found in the empty JSON string", ValuationsNNOREITDIRECTValuationRatios.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ValuationsNNOREITDIRECTValuationRatios.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ValuationsNNOREITDIRECTValuationRatios` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ValuationsNNOREITDIRECTValuationRatios.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ValuationsNNOREITDIRECTValuationRatios' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ValuationsNNOREITDIRECTValuationRatios> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ValuationsNNOREITDIRECTValuationRatios.class));

       return (TypeAdapter<T>) new TypeAdapter<ValuationsNNOREITDIRECTValuationRatios>() {
           @Override
           public void write(JsonWriter out, ValuationsNNOREITDIRECTValuationRatios value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ValuationsNNOREITDIRECTValuationRatios read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ValuationsNNOREITDIRECTValuationRatios given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ValuationsNNOREITDIRECTValuationRatios
   * @throws IOException if the JSON string is invalid with respect to ValuationsNNOREITDIRECTValuationRatios
   */
  public static ValuationsNNOREITDIRECTValuationRatios fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ValuationsNNOREITDIRECTValuationRatios.class);
  }

  /**
   * Convert an instance of ValuationsNNOREITDIRECTValuationRatios to an JSON string
   *
   * @return JSON string
   */
