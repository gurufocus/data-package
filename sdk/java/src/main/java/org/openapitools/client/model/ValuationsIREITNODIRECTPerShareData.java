...
public class ValuationsIREITNODIRECTPerShareData {
  ...
  public ValuationsIREITNODIRECTPerShareData() {
  }

  public ValuationsIREITNODIRECTPerShareData bookValuePerShare(@javax.annotation.Nullable BigDecimal bookValuePerShare) {
  ...
  public ValuationsIREITNODIRECTPerShareData cashFlowFromOperationsPerShare(@javax.annotation.Nullable BigDecimal cashFlowFromOperationsPerShare) {
  ...
  public ValuationsIREITNODIRECTPerShareData cashPerShare(@javax.annotation.Nullable BigDecimal cashPerShare) {
  ...
  public ValuationsIREITNODIRECTPerShareData dividendsPerShare(@javax.annotation.Nullable BigDecimal dividendsPerShare) {
  ...
  public ValuationsIREITNODIRECTPerShareData earningPerShareDiluted(@javax.annotation.Nullable BigDecimal earningPerShareDiluted) {
  ...
  public ValuationsIREITNODIRECTPerShareData ebitPerShare(@javax.annotation.Nullable BigDecimal ebitPerShare) {
  ...
  public ValuationsIREITNODIRECTPerShareData ebitdaPerShare(@javax.annotation.Nullable BigDecimal ebitdaPerShare) {
  ...
  public ValuationsIREITNODIRECTPerShareData epsWithoutNri(@javax.annotation.Nullable BigDecimal epsWithoutNri) {
  ...
  public ValuationsIREITNODIRECTPerShareData ffoPerShare(@javax.annotation.Nullable BigDecimal ffoPerShare) {
  ...
  public ValuationsIREITNODIRECTPerShareData freeCashFlowPerShare(@javax.annotation.Nullable BigDecimal freeCashFlowPerShare) {
  ...
  public ValuationsIREITNODIRECTPerShareData monthEndStockPrice(@javax.annotation.Nullable BigDecimal monthEndStockPrice) {
  ...
  public ValuationsIREITNODIRECTPerShareData ownerEarnings(@javax.annotation.Nullable BigDecimal ownerEarnings) {
  ...
  public ValuationsIREITNODIRECTPerShareData revenuePerShare(@javax.annotation.Nullable BigDecimal revenuePerShare) {
  ...
  public ValuationsIREITNODIRECTPerShareData tangiblesBookPerShare(@javax.annotation.Nullable BigDecimal tangiblesBookPerShare) {
  ...
  public ValuationsIREITNODIRECTPerShareData totalDebtPerShare(@javax.annotation.Nullable BigDecimal totalDebtPerShare) {
  ...
  public boolean equals(Object o) {
    ...
    ValuationsIREITNODIRECTPerShareData valuationsIREITNODIRECTPerShareData = (ValuationsIREITNODIRECTPerShareData) o;
    return Objects.equals(this.bookValuePerShare, valuationsIREITNODIRECTPerShareData.bookValuePerShare) &&
        Objects.equals(this.cashFlowFromOperationsPerShare, valuationsIREITNODIRECTPerShareData.cashFlowFromOperationsPerShare) &&
        Objects.equals(this.cashPerShare, valuationsIREITNODIRECTPerShareData.cashPerShare) &&
        Objects.equals(this.dividendsPerShare, valuationsIREITNODIRECTPerShareData.dividendsPerShare) &&
        Objects.equals(this.earningPerShareDiluted, valuationsIREITNODIRECTPerShareData.earningPerShareDiluted) &&
        Objects.equals(this.ebitPerShare, valuationsIREITNODIRECTPerShareData.ebitPerShare) &&
        Objects.equals(this.ebitdaPerShare, valuationsIREITNODIRECTPerShareData.ebitdaPerShare) &&
        Objects.equals(this.epsWithoutNri, valuationsIREITNODIRECTPerShareData.epsWithoutNri) &&
        Objects.equals(this.ffoPerShare, valuationsIREITNODIRECTPerShareData.ffoPerShare) &&
        Objects.equals(this.freeCashFlowPerShare, valuationsIREITNODIRECTPerShareData.freeCashFlowPerShare) &&
        Objects.equals(this.monthEndStockPrice, valuationsIREITNODIRECTPerShareData.monthEndStockPrice) &&
        Objects.equals(this.ownerEarnings, valuationsIREITNODIRECTPerShareData.ownerEarnings) &&
        Objects.equals(this.revenuePerShare, valuationsIREITNODIRECTPerShareData.revenuePerShare) &&
        Objects.equals(this.tangiblesBookPerShare, valuationsIREITNODIRECTPerShareData.tangiblesBookPerShare) &&
        Objects.equals(this.totalDebtPerShare, valuationsIREITNODIRECTPerShareData.totalDebtPerShare);
  }
  ...
  public String toString() {
    ...
    sb.append("class ValuationsIREITNODIRECTPerShareData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ValuationsIREITNODIRECTPerShareData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ValuationsIREITNODIRECTPerShareData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ValuationsIREITNODIRECTPerShareData is not found in the empty JSON string", ValuationsIREITNODIRECTPerShareData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ValuationsIREITNODIRECTPerShareData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ValuationsIREITNODIRECTPerShareData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ValuationsIREITNODIRECTPerShareData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ValuationsIREITNODIRECTPerShareData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ValuationsIREITNODIRECTPerShareData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ValuationsIREITNODIRECTPerShareData.class));

       return (TypeAdapter<T>) new TypeAdapter<ValuationsIREITNODIRECTPerShareData>() {
           @Override
           public void write(JsonWriter out, ValuationsIREITNODIRECTPerShareData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ValuationsIREITNODIRECTPerShareData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ValuationsIREITNODIRECTPerShareData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ValuationsIREITNODIRECTPerShareData
   * @throws IOException if the JSON string is invalid with respect to ValuationsIREITNODIRECTPerShareData
   */
  public static ValuationsIREITNODIRECTPerShareData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ValuationsIREITNODIRECTPerShareData.class);
  }

  /**
   * Convert an instance of ValuationsIREITNODIRECTPerShareData to an JSON string
   *
   * @return JSON string
   */
