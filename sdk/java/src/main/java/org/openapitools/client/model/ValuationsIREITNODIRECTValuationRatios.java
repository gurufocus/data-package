...
public class ValuationsIREITNODIRECTValuationRatios {
  ...
  public static final String SERIALIZED_NAME_PRICE_TO_FFO = "price_to_ffo";
  @SerializedName(SERIALIZED_NAME_PRICE_TO_FFO)
  @javax.annotation.Nullable
  ...
  public ValuationsIREITNODIRECTValuationRatios() {
  }

  public ValuationsIREITNODIRECTValuationRatios cyclicallyAdjustedPbRatio(@javax.annotation.Nullable BigDecimal cyclicallyAdjustedPbRatio) {
  ...
  public ValuationsIREITNODIRECTValuationRatios cyclicallyAdjustedPriceToFcf(@javax.annotation.Nullable BigDecimal cyclicallyAdjustedPriceToFcf) {
  ...
  public ValuationsIREITNODIRECTValuationRatios cyclicallyAdjustedPsRatio(@javax.annotation.Nullable BigDecimal cyclicallyAdjustedPsRatio) {
  ...
  public ValuationsIREITNODIRECTValuationRatios earningYieldGreenblatt(@javax.annotation.Nullable BigDecimal earningYieldGreenblatt) {
  ...
  public ValuationsIREITNODIRECTValuationRatios enterpriseValueToEbit(@javax.annotation.Nullable BigDecimal enterpriseValueToEbit) {
  ...
  public ValuationsIREITNODIRECTValuationRatios enterpriseValueToEbitda(@javax.annotation.Nullable BigDecimal enterpriseValueToEbitda) {
  ...
  public ValuationsIREITNODIRECTValuationRatios enterpriseValueToFcf(@javax.annotation.Nullable BigDecimal enterpriseValueToFcf) {
  ...
  public ValuationsIREITNODIRECTValuationRatios enterpriseValueToRevenue(@javax.annotation.Nullable BigDecimal enterpriseValueToRevenue) {
  ...
  public ValuationsIREITNODIRECTValuationRatios fcfYield(@javax.annotation.Nullable BigDecimal fcfYield) {
  ...
  public ValuationsIREITNODIRECTValuationRatios pbRatio(@javax.annotation.Nullable BigDecimal pbRatio) {
  ...
  public ValuationsIREITNODIRECTValuationRatios peRatio(@javax.annotation.Nullable BigDecimal peRatio) {
  ...
  public ValuationsIREITNODIRECTValuationRatios pegRatio(@javax.annotation.Nullable BigDecimal pegRatio) {
  ...
  public ValuationsIREITNODIRECTValuationRatios penri(@javax.annotation.Nullable BigDecimal penri) {
    this.penri = penri;
    return this;
  }
  ...
  public ValuationsIREITNODIRECTValuationRatios priceToFfo(@javax.annotation.Nullable BigDecimal priceToFfo) {
    this.priceToFfo = priceToFfo;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public BigDecimal getPriceToFfo() {
    return priceToFfo;
  }

  public void setPriceToFfo(@javax.annotation.Nullable BigDecimal priceToFfo) {
    this.priceToFfo = priceToFfo;
  }


  public ValuationsIREITNODIRECTValuationRatios priceToFreeCashFlow(@javax.annotation.Nullable BigDecimal priceToFreeCashFlow) {
  ...
  public ValuationsIREITNODIRECTValuationRatios priceToOperatingCashFlow(@javax.annotation.Nullable BigDecimal priceToOperatingCashFlow) {
  ...
  public ValuationsIREITNODIRECTValuationRatios priceToOwnerEarnings(@javax.annotation.Nullable BigDecimal priceToOwnerEarnings) {
  ...
  public ValuationsIREITNODIRECTValuationRatios priceToTangibleBook(@javax.annotation.Nullable BigDecimal priceToTangibleBook) {
  ...
  public ValuationsIREITNODIRECTValuationRatios psRatio(@javax.annotation.Nullable BigDecimal psRatio) {
  ...
  public ValuationsIREITNODIRECTValuationRatios rateOfReturnValue(@javax.annotation.Nullable BigDecimal rateOfReturnValue) {
  ...
  public ValuationsIREITNODIRECTValuationRatios shillerPeRatio(@javax.annotation.Nullable BigDecimal shillerPeRatio) {
  ...
  public ValuationsIREITNODIRECTValuationRatios yield(@javax.annotation.Nullable BigDecimal yield) {
    this.yield = yield;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ValuationsIREITNODIRECTValuationRatios valuationsIREITNODIRECTValuationRatios = (ValuationsIREITNODIRECTValuationRatios) o;
    return Objects.equals(this.cyclicallyAdjustedPbRatio, valuationsIREITNODIRECTValuationRatios.cyclicallyAdjustedPbRatio) &&
        Objects.equals(this.cyclicallyAdjustedPriceToFcf, valuationsIREITNODIRECTValuationRatios.cyclicallyAdjustedPriceToFcf) &&
        Objects.equals(this.cyclicallyAdjustedPsRatio, valuationsIREITNODIRECTValuationRatios.cyclicallyAdjustedPsRatio) &&
        Objects.equals(this.earningYieldGreenblatt, valuationsIREITNODIRECTValuationRatios.earningYieldGreenblatt) &&
        Objects.equals(this.enterpriseValueToEbit, valuationsIREITNODIRECTValuationRatios.enterpriseValueToEbit) &&
        Objects.equals(this.enterpriseValueToEbitda, valuationsIREITNODIRECTValuationRatios.enterpriseValueToEbitda) &&
        Objects.equals(this.enterpriseValueToFcf, valuationsIREITNODIRECTValuationRatios.enterpriseValueToFcf) &&
        Objects.equals(this.enterpriseValueToRevenue, valuationsIREITNODIRECTValuationRatios.enterpriseValueToRevenue) &&
        Objects.equals(this.fcfYield, valuationsIREITNODIRECTValuationRatios.fcfYield) &&
        Objects.equals(this.pbRatio, valuationsIREITNODIRECTValuationRatios.pbRatio) &&
        Objects.equals(this.peRatio, valuationsIREITNODIRECTValuationRatios.peRatio) &&
        Objects.equals(this.pegRatio, valuationsIREITNODIRECTValuationRatios.pegRatio) &&
        Objects.equals(this.penri, valuationsIREITNODIRECTValuationRatios.penri) &&
        Objects.equals(this.priceToFfo, valuationsIREITNODIRECTValuationRatios.priceToFfo) &&
        Objects.equals(this.priceToFreeCashFlow, valuationsIREITNODIRECTValuationRatios.priceToFreeCashFlow) &&
        Objects.equals(this.priceToOperatingCashFlow, valuationsIREITNODIRECTValuationRatios.priceToOperatingCashFlow) &&
        Objects.equals(this.priceToOwnerEarnings, valuationsIREITNODIRECTValuationRatios.priceToOwnerEarnings) &&
        Objects.equals(this.priceToTangibleBook, valuationsIREITNODIRECTValuationRatios.priceToTangibleBook) &&
        Objects.equals(this.psRatio, valuationsIREITNODIRECTValuationRatios.psRatio) &&
        Objects.equals(this.rateOfReturnValue, valuationsIREITNODIRECTValuationRatios.rateOfReturnValue) &&
        Objects.equals(this.shillerPeRatio, valuationsIREITNODIRECTValuationRatios.shillerPeRatio) &&
        Objects.equals(this.yield, valuationsIREITNODIRECTValuationRatios.yield);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cyclicallyAdjustedPbRatio, cyclicallyAdjustedPriceToFcf, cyclicallyAdjustedPsRatio, earningYieldGreenblatt, enterpriseValueToEbit, enterpriseValueToEbitda, enterpriseValueToFcf, enterpriseValueToRevenue, fcfYield, pbRatio, peRatio, pegRatio, penri, priceToFfo, priceToFreeCashFlow, priceToOperatingCashFlow, priceToOwnerEarnings, priceToTangibleBook, psRatio, rateOfReturnValue, shillerPeRatio, yield);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ValuationsIREITNODIRECTValuationRatios {\n");
    ...
    sb.append("    priceToFfo: ").append(toIndentedString(priceToFfo)).append("\n");
  ...
  static {
    ...
    openapiFields.add("price_to_ffo");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ValuationsIREITNODIRECTValuationRatios
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ValuationsIREITNODIRECTValuationRatios.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ValuationsIREITNODIRECTValuationRatios is not found in the empty JSON string", ValuationsIREITNODIRECTValuationRatios.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ValuationsIREITNODIRECTValuationRatios.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ValuationsIREITNODIRECTValuationRatios` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ValuationsIREITNODIRECTValuationRatios.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ValuationsIREITNODIRECTValuationRatios' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ValuationsIREITNODIRECTValuationRatios> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ValuationsIREITNODIRECTValuationRatios.class));

       return (TypeAdapter<T>) new TypeAdapter<ValuationsIREITNODIRECTValuationRatios>() {
           @Override
           public void write(JsonWriter out, ValuationsIREITNODIRECTValuationRatios value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ValuationsIREITNODIRECTValuationRatios read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ValuationsIREITNODIRECTValuationRatios given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ValuationsIREITNODIRECTValuationRatios
   * @throws IOException if the JSON string is invalid with respect to ValuationsIREITNODIRECTValuationRatios
   */
  public static ValuationsIREITNODIRECTValuationRatios fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ValuationsIREITNODIRECTValuationRatios.class);
  }

  /**
   * Convert an instance of ValuationsIREITNODIRECTValuationRatios to an JSON string
   *
   * @return JSON string
   */
